...
function iso8601ParseTest() {
  ...
  print(
    Date.parse("1234-05-06T07:08:09.123Z"),
  ...
  print(
    Date.parse("1234-05-06T07:08:09.123Z"), // should default to these
  ...
  print(
    Date.parse("2010-01-02T03:04:05.006"),
  ...
  print(
    Date.parse("-283457-03-21T15:00:00.008Z"), // out of valid E5 range
    ...
    Date.parse("+287396-10-12T08:59:00.992Z")
  ); // out of valid E5 range
  ...
  print(
    Date.parse("-100000-01-02T03:04:05.006Z"),
