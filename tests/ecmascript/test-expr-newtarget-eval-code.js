...
try {
  ...
  eval(
    '(function test() { eval("print(typeof new.target); print(new.target === test);"); })()'
  );
  eval(
    'new (function test() { eval("print(typeof new.target); print(new.target === test);"); })'
  );
} catch (e) {
  print(e.name);
}
...
try {
  ...
  eval(
    '(function test() { eval("eval(\\"print(typeof new.target); print(new.target === test);\\");"); })()'
  );
  eval(
    'new (function test() { eval("eval(\\"print(typeof new.target); print(new.target === test);\\");"); })'
  );
} catch (e) {
  print(e.stack);
}
