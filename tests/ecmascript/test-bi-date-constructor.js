...
function dateConstructorTest() {
  ...
  // MakeDate / MakeTime
  d = new Date(300000, 1, 2, 3, 4, 5, 6);
  toUtcAndPrint(d);
  d = new Date(-300000, 1, 2, 3, 4, 5, 6);
  toUtcAndPrint(d);
  d = new Date("foo", 1, 2, 3, 4, 5, 6);
  toUtcAndPrint(d);
  d = new Date(2013, -1, 2, 3, 4, 5, 6);
  toUtcAndPrint(d); // out of range months affect year (see MakeDate),
  d = new Date(2013, 12, 2, 3, 4, 5, 6);
  toUtcAndPrint(d); // so these two result in valid dates
  d = new Date(2013, "foo", 2, 3, 4, 5, 6);
  toUtcAndPrint(d);
  d = new Date(2013, 1, 0, 3, 4, 5, 6);
  toUtcAndPrint(d); // again, out of range days are allowed (MakeDate)
  d = new Date(2013, 1, 32, 3, 4, 5, 6);
  toUtcAndPrint(d); // -""-
  d = new Date(2013, 1, "foo", 3, 4, 5, 6);
  toUtcAndPrint(d);
  d = new Date(2013, 1, 2, 3, -1, 5, 6);
  toUtcAndPrint(d); // allowed
  d = new Date(2013, 1, 2, 3, 24, 5, 6);
  toUtcAndPrint(d); // -""-
  d = new Date(2013, 1, 2, 3, "foo", 5, 6);
  toUtcAndPrint(d);
  d = new Date(2013, 1, 2, 3, 4, -1, 6);
  toUtcAndPrint(d); // allowed
  d = new Date(2013, 1, 2, 3, 4, 60, 6);
  toUtcAndPrint(d); // -""-
  d = new Date(2013, 1, 2, 3, 4, "foo", 6);
  toUtcAndPrint(d);
  d = new Date(2013, 1, 2, 3, 4, 5, -1);
  toUtcAndPrint(d); // allowed
  d = new Date(2013, 1, 2, 3, 4, 5, 1000);
  toUtcAndPrint(d); // -""-
  d = new Date(2013, 1, 2, 3, 4, 5, "foo");
  toUtcAndPrint(d);

  // express a large timestamp with milliseconds only
  d = new Date(2012, 1, 2, 3, 4, 5, 6);
  toUtcAndPrint(d); // this ...
  d = new Date(2012, 0, 0, 0, 0, 0, 2862245006);
  toUtcAndPrint(d); // ... is equivalent to this

  // argument defaulting
  d = new Date(2012, 1, 2, 3, 4, 5, 6);
  toUtcAndPrint(d);
  d = new Date(2012, 1, 2, 3, 4, 5);
  toUtcAndPrint(d);
  d = new Date(2012, 1, 2, 3, 4);
  toUtcAndPrint(d);
  d = new Date(2012, 1, 2, 3);
  toUtcAndPrint(d);
  d = new Date(2012, 1, 2);
  toUtcAndPrint(d);
  d = new Date(2012, 1);
