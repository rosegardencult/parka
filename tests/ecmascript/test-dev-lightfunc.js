...
var objLengthKey = {
  toString: function() {
    print('toString coerced object (return "length")');
    return "length";
  }
};
...
function toObjectTest() {
  ...
  print(
    "internal prototype is Function.prototype:",
    Object.getPrototypeOf(lightFunc) === Function.prototype,
    Object.getPrototypeOf(normalFunc) === Function.prototype
  );
  print("external prototype is not set:", lightFunc.prototype === undefined);
  print(
    "internal prototypes match:",
    Object.getPrototypeOf(lightFunc) === Object.getPrototypeOf(normalFunc)
  );
  print(
    "external prototypes match (do not exist):",
  ...
  print(
    "isExtensible:",
    Object.isExtensible(lightFunc),
    Object.isExtensible(normalFunc)
  );
  ...
  print(
    "Math.max test:",
    lightFunc(1, 5, 7, 4, 9, 2),
    normalFunc(1, 5, 7, 4, 9, 2)
  );
...
function propertyGetTest() {
  ...
  var testKeys = [
    ...
    "call",
    "apply", // inherited, standard built-in
...
function propertyDeleteTest() {
  ...
  try {
    (function() {
      print("non-strict:", delete func.nonexistent);
    })();
  } catch (e) {
    print(e);
  }
  try {
    (function() {
      "use strict";
      print("strict:", delete func.nonexistent);
    })();
  } catch (e) {
    print(e);
  }
...
function duktapeActTest() {
  ...
  ["foo"].forEach(function callback(x) {
    ...
    for (i = -1; ; i--) {
      ...
      print(
        i,
        Duktape.enc("jx", Object.getOwnPropertyNames(a)),
        sanitizeLfunc(a.function.name)
      );
    }
  });
}
...
function getOwnPropertyDescriptorTest() {
  ...
  function test(key) {
    ...
    print(
      "value:",
      typeof pd.value,
      typeof pd.value === "string" ? sanitizeLfunc(pd.value) : pd.value
    );
...
function setPrototypeOfTest() {
  ...
  err(function() {
    ...
    Object.setPrototypeOf(nonext, {});
  });
  err(function() {
    Object.setPrototypeOf(lfunc, {});
  });
  ...
  succ(function() {
    var nonext = {};
    Object.preventExtensions(nonext);
    Object.setPrototypeOf(nonext, Object.prototype);
  });
  succ(function() {
    Object.setPrototypeOf(lfunc, Function.prototype);
  });

  succ(function() {
    var nonext = {};
    Object.preventExtensions(nonext);
    nonext.__proto__ = Object.prototype;
  });
  succ(function() {
    lfunc.__proto__ = Function.prototype;
  });
}
...
function arrayBuiltinTest() {
  ...
  testTypedJx(function() {
    return new Array(lfunc);
  }, "new Array");
  testTypedJx(function() {
    return Array.isArray(lfunc);
  }, "isArray");
...
function booleanBuiltinTest() {
  ...
  testTypedJx(function() {
    return Boolean(lfunc);
  }, "Boolean");
  testTypedJx(function() {
    return new Boolean(lfunc);
  }, "new Boolean");
  testTypedJx(function() {
    return Boolean.prototype.toString.call(lfunc, lfunc);
  }, "toString");
  testTypedJx(function() {
    return Boolean.prototype.valueOf.call(lfunc, lfunc);
  }, "valueOf");
}
...
function duktapeBufferBuiltinTest() {
  ...
  testTypedJx(function() {
    return Duktape.Buffer(lfunc);
  }, "Duktape.Buffer");
  testTypedJx(function() {
    return new Duktape.Buffer(lfunc);
  }, "new Duktape.buffer");
  testTypedJx(function() {
    return Duktape.Buffer.prototype.toString.call(lfunc, lfunc);
  }, "toString");
  testTypedJx(function() {
    return Duktape.Buffer.prototype.valueOf.call(lfunc, lfunc);
  }, "valueOf");
}
...
function dateBuiltinTest() {
  ...
  testTypedJx(function() {
    return typeof Date(lfunc);
  }, "Date");
  testTypedJx(function() {
    return typeof new Date(lfunc);
  }, "new Date");
  testTypedJx(function() {
    return Date.parse(lfunc);
  }, "parse");
  testTypedJx(function() {
    return Date.UTC(lfunc);
  }, "UTC");
  testTypedJx(function() {
    return typeof Date.now(lfunc);
  }, "now");
...
function duktapeBuiltinTest() {
  ...
  testTypedJx(function() {
    return getValuePublicType(lfunc);
  }, "info");

  // doesn't really make sense
  testTypedJx(function() {
    return Duktape.act(lfunc);
  }, "act");

  // doesn't really make sense (will act like Duktape.gc(0))
  testTypedJx(function() {
    return Duktape.gc(lfunc);
  }, "gc");

  // attempt to get finalizer
  testTypedJx(function() {
    return Duktape.fin(lfunc);
  }, "fin-get");

  // attempt to set finalizer
  testTypedJx(function() {
    return Duktape.fin(lfunc, function() {});
  }, "fin-set");

  testTypedJx(function() {
    return sanitizeLfunc(
      bufferToStringRaw(Duktape.dec("hex", Duktape.enc("hex", lfunc)))
    );
  }, "encdec-hex");
  testTypedJx(function() {
    return Duktape.dec("hex", lfunc);
  }, "dec-hex");

  // attempt to compact is a no-op
  testTypedJx(function() {
    return Duktape.compact(lfunc);
  }, "compact");
}
...
function errorBuiltinTest() {
  ...
  testTypedJx(function() {
    return new Error(lfunc);
  }, "new Error");
  testTypedJx(function() {
    return sanitizeLfunc(Error.prototype.toString.call(lfunc, lfunc));
  }, "toString");
  testTypedJx(function() {
    return Error.prototype.valueOf.call(lfunc, lfunc);
  }, "valueOf");
}
...
function functionBuiltinTest() {
  ...
  testTypedJx(function() {
    return Function(lfunc);
  }, "Function");
  testTypedJx(function() {
    return new Function(lfunc);
  }, "new Function");
  testTypedJx(function() {
    return sanitizeLfunc(Function.prototype.toString.call(lfunc, lfunc));
  }, "toString");
  testTypedJx(function() {
    return Function.prototype.valueOf.call(lfunc, lfunc);
  }, "valueOf");
...
function globalBuiltinTest() {
  ...
  testTypedJx(function() {
    return parseInt(lfunc);
  }, "parseInt");
  testTypedJx(function() {
    return parseFloat(lfunc);
  }, "parseFloat");
  testTypedJx(function() {
    return isNaN(lfunc);
  }, "isNaN");
  testTypedJx(function() {
    return isFinite(lfunc);
  }, "isFinite");

  // Must sanitize here
  testTypedJx(function() {
    return sanitizeLfunc(decodeURI(lfunc));
  }, "decodeURI");
  testTypedJx(function() {
    return sanitizeLfunc(decodeURIComponent(lfunc));
  }, "decodeURIComponent");

  // The encoded output would need to be sanitized; just check it's a string
  testTypedJx(function() {
    return typeof encodeURI(lfunc);
  }, "encodeURI");
  testTypedJx(function() {
    return typeof encodeURIComponent(lfunc);
  }, "encodeURIComponent");
  testTypedJx(function() {
    return typeof escape(lfunc);
  }, "escape");
  testTypedJx(function() {
    return typeof unescape(lfunc);
  }, "unescape");
}
...
function jsonBuiltinTest() {
  ...
  testTypedJx(function() {
    return JSON.parse(lfunc);
  }, "parse");
  testTypedJx(function() {
    return JSON.stringify(lfunc);
  }, "stringify");
}
...
function duktapeLoggerBuiltinTest() {
  ...
  testTypedJx(function() {
    return Duktape.Logger(lfunc);
  }, "Duktape.Logger");
  testTypedJx(function() {
    return new Duktape.Logger(lfunc);
  }, "new Duktape.Logger");
  testTypedJx(function() {
    return Duktape.logger.prototype.fmt(lfunc);
  }, "fmt");
  testTypedJx(function() {
    return Duktape.logger.prototype.raw(lfunc);
  }, "raw");
...
function mathBuiltinTest() {
  ...
  testTypedJx(function() {
    return Math.abs(lfunc);
  }, "abs");
  testTypedJx(function() {
    return Math.acos(lfunc);
  }, "acos");
  testTypedJx(function() {
    return Math.asin(lfunc);
  }, "asin");
  testTypedJx(function() {
    return Math.atan(lfunc);
  }, "atan");
  testTypedJx(function() {
    return Math.atan2(lfunc);
  }, "atan2");
  testTypedJx(function() {
    return Math.ceil(lfunc);
  }, "ceil");
  testTypedJx(function() {
    return Math.cos(lfunc);
  }, "cos");
  testTypedJx(function() {
    return Math.exp(lfunc);
  }, "exp");
  testTypedJx(function() {
    return Math.floor(lfunc);
  }, "floor");
  testTypedJx(function() {
    return Math.log(lfunc);
  }, "log");
  testTypedJx(function() {
    return Math.max(lfunc);
  }, "max");
  testTypedJx(function() {
    return Math.min(lfunc);
  }, "min");
  testTypedJx(function() {
    return Math.pow(lfunc);
  }, "pow");
  testTypedJx(function() {
    return typeof Math.random(lfunc);
  }, "random"); // avoid outputting result value
  testTypedJx(function() {
    return Math.round(lfunc);
  }, "round");
  testTypedJx(function() {
    return Math.sin(lfunc);
  }, "sin");
  testTypedJx(function() {
    return Math.sqrt(lfunc);
  }, "sqrt");
  testTypedJx(function() {
    return Math.tan(lfunc);
  }, "tan");
}
...
function numberBuiltinTest() {
  ...
  testTypedJx(function() {
    return new Number(lfunc);
  }, "new Number");
  testTypedJx(function() {
    return Number.prototype.toString.call(lfunc, lfunc);
  }, "toString");
  testTypedJx(function() {
    return Number.prototype.toLocaleString.call(lfunc, lfunc);
  }, "toLocaleString");
  testTypedJx(function() {
    return Number.prototype.valueOf.call(lfunc, lfunc);
  }, "valueOf");
  testTypedJx(function() {
    return Number.prototype.toFixed.call(lfunc, lfunc);
  }, "toFixed");
  testTypedJx(function() {
    return Number.prototype.toExponential.call(lfunc, lfunc);
  }, "toExponential");
  testTypedJx(function() {
    return Number.prototype.toPrecision.call(lfunc, lfunc);
  }, "toPrecision");
}
...
function objectBuiltinTest() {
  ...
  testTypedJx(function() {
    return new Object(lfunc);
  }, "new Object");
  testTypedJx(function() {
    return Object.getPrototypeOf(lfunc);
  }, "getPrototypeOf");
  testTypedJx(function() {
    return Object.setPrototypeOf(lfunc, {});
  }, "setPrototypeOf");
  testTypedJx(function() {
    return Object.seal(lfunc);
  }, "seal");
  testTypedJx(function() {
    return Object.freeze(lfunc);
  }, "freeze");
  testTypedJx(function() {
    return Object.preventExtensions(lfunc);
  }, "preventExtensions");
  testTypedJx(function() {
    return Object.isSealed(lfunc);
  }, "isSealed");
  testTypedJx(function() {
    return Object.isFrozen(lfunc);
  }, "isFrozen");
  testTypedJx(function() {
    return Object.isExtensible(lfunc);
  }, "isExtensible");
  ...
  testTypedJx(function() {
    return Object.prototype.toString.call(lfunc, lfunc);
  }, "toString");
  testTypedJx(function() {
    return sanitizeLfunc(Object.prototype.toLocaleString.call(lfunc, lfunc));
  }, "toLocaleString");
  testTypedJx(function() {
    return Object.prototype.valueOf.call(lfunc, lfunc);
  }, "valueOf");
  testTypedJx(function() {
    return Object.prototype.isPrototypeOf.call(lfunc, lfunc);
  }, "isPrototypeOf");
}
...
function duktapePointerBuiltinTest() {
  ...
  testTypedJx(function() {
    return Duktape.Pointer.prototype.toString.call(lfunc);
  }, "toString");
  testTypedJx(function() {
    return Duktape.Pointer.prototype.toString.call(lfunc);
  }, "valueOf");
...
function regexpBuiltinTest() {
  ...
  testTypedJx(function() {
    return new RegExp(lfunc);
  }, "new RegExp");

  testTypedJx(function() {
    return RegExp.prototype.exec.call(lfunc, lfunc);
  }, "exec");
  testTypedJx(function() {
    return RegExp.prototype.test.call(lfunc, lfunc);
  }, "test");
  testTypedJx(function() {
    return RegExp.prototype.toString.call(lfunc, lfunc);
  }, "toString");
  testTypedJx(function() {
    return RegExp.prototype.valueOf.call(lfunc, lfunc);
  }, "valueOf");
}
...
function stringBuiltinTest() {
  ...
  testTypedJx(function() {
    return sanitizeLfunc(String(lfunc));
  }, "String");

  // new String() returns an object, but sanitizeLfunc() coerces it to a
  // plain string; check return type separately
  testTypedJx(function() {
    return sanitizeLfunc(new String(lfunc));
  }, "new String");
  testTypedJx(function() {
    return typeof new String(lfunc);
  }, "new String");

  testTypedJx(function() {
    return String.fromCharCode(lfunc);
  }, "fromCharCode");

  testTypedJx(function() {
    return String.prototype.toString.call(lfunc, lfunc);
  }, "toString");
  testTypedJx(function() {
    return String.prototype.valueOf.call(lfunc, lfunc);
  }, "valueOf");
  testTypedJx(function() {
    return String.prototype.charAt.call(lfunc, lfunc);
  }, "charAt");
  testTypedJx(function() {
    return String.prototype.charCodeAt.call(lfunc, lfunc);
  }, "charCodeAt");
  testTypedJx(function() {
    return sanitizeLfunc(String.prototype.concat.call(lfunc, lfunc));
  }, "concat");
  testTypedJx(function() {
    return String.prototype.indexOf.call(lfunc, lfunc);
  }, "indexOf");
  testTypedJx(function() {
    return String.prototype.lastIndexOf.call(lfunc, lfunc);
  }, "lastIndexOf");
  testTypedJx(function() {
    return String.prototype.localeCompare.call(lfunc, lfunc);
  }, "localeCompare");
  testTypedJx(function() {
    return String.prototype.match.call(lfunc, lfunc);
  }, "match");
  testTypedJx(function() {
    return String.prototype.replace.call(lfunc, lfunc);
  }, "replace");
  testTypedJx(function() {
    return String.prototype.search.call(lfunc, lfunc);
  }, "search");
  testTypedJx(function() {
    return sanitizeLfunc(String.prototype.slice.call(lfunc, lfunc));
  }, "slice");
  testTypedJx(function() {
    return String.prototype.split.call(lfunc, lfunc);
  }, "split");
  testTypedJx(function() {
    return sanitizeLfunc(String.prototype.substring.call(lfunc, lfunc));
  }, "substring");
  testTypedJx(function() {
    return sanitizeLfunc(String.prototype.toLowerCase.call(lfunc, lfunc));
  }, "toLowerCase");
  testTypedJx(function() {
    return sanitizeLfunc(String.prototype.toLocaleLowerCase.call(lfunc, lfunc));
  }, "toLocaleLowerCase");
  testTypedJx(function() {
    return sanitizeLfunc(String.prototype.toUpperCase.call(lfunc, lfunc));
  }, "toUpperCase");
  testTypedJx(function() {
    return sanitizeLfunc(String.prototype.toLocaleUpperCase.call(lfunc, lfunc));
  }, "toLocaleUpperCase");
  testTypedJx(function() {
    return sanitizeLfunc(String.prototype.trim.call(lfunc, lfunc));
  }, "trim");
  testTypedJx(function() {
    return sanitizeLfunc(String.prototype.substr.call(lfunc, lfunc));
  }, "substr");
}
