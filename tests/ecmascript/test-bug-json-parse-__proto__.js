...
function test() {
  ...
  print("reviver case");
  dump(
    JSON.parse('{"__proto__":[]}', function(name, val) {
      // this=holder
      print("reviver:", name);
      return val;
    })
  ...
  dump(
    JSON.parse('{"foo":"bar", "__proto__":[1,2,3]}', function(name, val) {
      // this=holder
      print("reviver:", name, Object.getOwnPropertyDescriptor(this, name), val);
      if (name === "foo") {
        // Delete '__proto__' while reviving 'foo'.
        print(
          "before: this.__proto__:",
          Object.getOwnPropertyDescriptor(this, "__proto__")
        );
        delete this.__proto__;
        print(
          "after: this.__proto__:",
          Object.getOwnPropertyDescriptor(this, "__proto__")
        );
      }
      if (name === "__proto__") {
