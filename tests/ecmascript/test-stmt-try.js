...
try {
  ...
  eval(
    "try { throw 'foo' } catch (e) { print(e); try { throw 'bar' } catch (e) { print(e) }; print(e) }"
  );
} catch (e) {
  print(e.name);
}
...
try {
  ...
  eval(
    "(function (x, y) { print(x, y); try { throw 'foo' } catch (x) { print(x, y); }; print(x, y); })(123, 234)"
  );
} catch (e) {
  print(e.name);
}
...
try {
  ...
  eval(
    "(function (x, y) { function fn() {} print(typeof fn); try { throw 'foo' } catch (fn) { print(typeof fn) }; print(typeof fn); })(123, 234)"
  );
} catch (e) {
  print(e.name);
}
...
try {
  eval(
    "'use strict'; try { print('try'); } catch (arguments) { print('catch'); }"
  );
  print("try finished");
} catch (e) {
  print(e.name);
