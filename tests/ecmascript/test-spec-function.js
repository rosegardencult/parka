...
function nonstrict_evalargs(eval, arguments) {
...
try {
   ...
   */
  eval(
    "function nonstrict_else(else) { print('else'); }\n" + "nonstrict_else(1);"
  );
} catch (e) {
  print(e.name);
}
...
try {
  eval(
    "function nonstrict_class(class) { print('class'); }\n" +
      "nonstrict_class(1);"
  );
} catch (e) {
  print(e.name);
...
function nonstrict_package(package) {
  print(package);
}
nonstrict_package(1);
