...
function symbolEnumerationTest() {
  ...
  if (typeof Duktape === "object") {
    var internalKey1 = bufferToStringRaw(
      Duktape.dec("hex", "ff696e68456e756d53796d48696464656e")
    ); // _InhEnumSymHidden
    var internalKey2 = bufferToStringRaw(
      Duktape.dec("hex", "ff696e684e6f6e456e756d53796d48696464656e")
    ); // _InhNonEnumSymHidden
    var internalKey3 = bufferToStringRaw(
      Duktape.dec("hex", "ff4f776e456e756d53796d48696464656e")
    ); // _OwnEnumSymHidden
    var internalKey4 = bufferToStringRaw(
      Duktape.dec("hex", "ff4f776e4e6f6e456e756d53796d48696464656e")
    ); // _OwnNonEnumSymHidden
  } else {
