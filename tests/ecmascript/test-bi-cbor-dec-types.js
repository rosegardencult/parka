...
function testOne(hexInput, expect, opts) {
  ...
  var truncLimit = 255;
  var prInput =
    hexInput.length > truncLimit
      ? hexInput.substring(0, truncLimit) + "..."
      : hexInput;
  var jxExpect = Duktape.enc("jx", expect);
  var prExpect =
    jxExpect.length > truncLimit
      ? jxExpect.substring(0, truncLimit) + "..."
      : jxExpect;
  try {
    var result = CBOR.decode(Duktape.dec("hex", hexInput).buffer);
    var jxResult = Duktape.enc("jx", result);
    var prResult =
      jxResult.length > truncLimit
        ? jxResult.substring(0, truncLimit) + "..."
        : jxResult;
    if (!opts.silent) {
...
try {
  ...
  (function() {
    ...
    print(
      "proto is Uint8Array.prototype:",
      Object.getPrototypeOf(res) === Uint8Array.prototype
    );
...
test(
  "47666f6f00666f6f",
  new Uint8Array([0x66, 0x6f, 0x6f, 0x00, 0x66, 0x6f, 0x6f])
);
test(
  "481122334455667788",
...
test(
  "4e112233445566778899aabbccddee",
  new Uint8Array([
    0x11,
    0x22,
    0x33,
...
test(
  "4f112233445566778899aabbccddeeff",
  new Uint8Array([
    0x11,
    0x22,
    0x33,
...
test(
  "50112233445566778899aabbccddeeff00",
  new Uint8Array([
    0x11,
    0x22,
    0x33,
...
test(
  "51112233445566778899aabbccddeeff0011",
  new Uint8Array([
    0x11,
    0x22,
    0x33,
...
test(
  "52112233445566778899aabbccddeeff001122",
  new Uint8Array([
    0x11,
    0x22,
    0x33,
...
test(
  "53112233445566778899aabbccddeeff00112233",
  new Uint8Array([
    0x11,
    0x22,
    0x33,
...
test(
  "54112233445566778899aabbccddeeff0011223344",
  new Uint8Array([
    0x11,
    0x22,
    0x33,
...
test(
  "55112233445566778899aabbccddeeff001122334455",
  new Uint8Array([
    0x11,
    0x22,
    0x33,
...
test(
  "56112233445566778899aabbccddeeff00112233445566",
  new Uint8Array([
    0x11,
    0x22,
    0x33,
...
test(
  "5817112233445566778899aabbccddeeff0011223344556677",
  new Uint8Array([
    0x11,
    0x22,
    0x33,
...
test(
  "5818112233445566778899aabbccddeeff001122334455667788",
  new Uint8Array([
    0x11,
    0x22,
    0x33,
...
test(
  "5b0000000001000000" + "fe".repeat(0x1000000),
  mkbuf("fe".repeat(0x1000000))
);
test("5c", ERROR);
test("5c00", ERROR);
test("5cff", ERROR);
...
test(
  "5f" + "40".repeat(10000) + "43112233" + "40".repeat(10000) + "ff",
  mkbuf("112233")
);
...
test(
  "7541efbb9c42434445464748494a4b4c4d4e4f505152",
  "A\ufedcBCDEFGHIJKLMNOPQR"
);
test(
  "7641efbb9c42434445464748494a4b4c4d4e4f50515253",
  "A\ufedcBCDEFGHIJKLMNOPQRS"
);
test(
  "7741efbb9c42434445464748494a4b4c4d4e4f5051525354",
  "A\ufedcBCDEFGHIJKLMNOPQRST"
);
test("78", ERROR);
test("7800", "");
test("78026162", "ab");
test(
  "781741efbb9c42434445464748494a4b4c4d4e4f5051525354",
  "A\ufedcBCDEFGHIJKLMNOPQRST"
);
...
try {
  (function() {
    ...
    print(
      "proto is Array.prototype:",
      Object.getPrototypeOf(res) === Array.prototype
    );
    print("is bare:", Object.getPrototypeOf(res) === null);
  })();
} catch (e) {
...
test("8d000102030405060708090a0b0c", [
  0,
  1,
  2,
  3,
...
test("8e000102030405060708090a0b0c0d", [
  0,
  1,
  2,
  3,
...
test("8f000102030405060708090a0b0c0d0e", [
  0,
  1,
  2,
  3,
...
test("90000102030405060708090a0b0c0d0e0f", [
  0,
  1,
  2,
  3,
...
test("91000102030405060708090a0b0c0d0e0f10", [
  0,
  1,
  2,
  3,
...
test("92000102030405060708090a0b0c0d0e0f1011", [
  0,
  1,
  2,
  3,
...
test("93000102030405060708090a0b0c0d0e0f101112", [
  0,
  1,
  2,
  3,
...
test("94000102030405060708090a0b0c0d0e0f10111213", [
  0,
  1,
  2,
  3,
...
test("95000102030405060708090a0b0c0d0e0f1011121314", [
  0,
  1,
  2,
  3,
...
test("96000102030405060708090a0b0c0d0e0f101112131415", [
  0,
  1,
  2,
  3,
...
test("97000102030405060708090a0b0c0d0e0f10111213141516", [
  0,
  1,
  2,
  3,
...
test("a36141a2010203046142a105066143a0", {
  A: { 1: 2, 3: 4 },
  B: { 5: 6 },
  C: {}
});
...
test("a7000102030405060708090a0b0c0d", {
  0: 1,
  2: 3,
  4: 5,
  6: 7,
...
test("a8000102030405060708090a0b0c0d0e0f", {
  0: 1,
  2: 3,
  4: 5,
  6: 7,
...
test("a9000102030405060708090a0b0c0d0e0f1011", {
  0: 1,
  2: 3,
  4: 5,
  6: 7,
...
test("aa000102030405060708090a0b0c0d0e0f10111213", {
  0: 1,
  2: 3,
  4: 5,
  6: 7,
...
test("ab000102030405060708090a0b0c0d0e0f101112131415", {
  0: 1,
  2: 3,
  4: 5,
  6: 7,
...
test("ac000102030405060708090a0b0c0d0e0f1011121314151617", {
  0: 1,
  2: 3,
  4: 5,
  6: 7,
...
test("ad000102030405060708090a0b0c0d0e0f101112131415161718181819", {
  0: 1,
  2: 3,
  4: 5,
  6: 7,
...
test("ae000102030405060708090a0b0c0d0e0f101112131415161718181819181a181b", {
  0: 1,
  2: 3,
  4: 5,
  6: 7,
...
test(
  "af000102030405060708090a0b0c0d0e0f101112131415161718181819181a181b181c181d",
  {
    0: 1,
    2: 3,
    4: 5,
...
test(
  "b0000102030405060708090a0b0c0d0e0f101112131415161718181819181a181b181c181d181e181f",
  {
    0: 1,
    2: 3,
    4: 5,
...
test(
  "b1000102030405060708090a0b0c0d0e0f101112131415161718181819181a181b181c181d181e181f18201821",
  {
    0: 1,
    2: 3,
    4: 5,
...
test(
  "b2000102030405060708090a0b0c0d0e0f101112131415161718181819181a181b181c181d181e181f1820182118221823",
  {
    0: 1,
    2: 3,
    4: 5,
...
test(
  "b3000102030405060708090a0b0c0d0e0f101112131415161718181819181a181b181c181d181e181f182018211822182318241825",
  {
    0: 1,
    2: 3,
    4: 5,
...
test(
  "b4000102030405060708090a0b0c0d0e0f101112131415161718181819181a181b181c181d181e181f18201821182218231824182518261827",
  {
    0: 1,
    2: 3,
    4: 5,
...
test(
  "b5000102030405060708090a0b0c0d0e0f101112131415161718181819181a181b181c181d181e181f1820182118221823182418251826182718281829",
  {
    0: 1,
    2: 3,
    4: 5,
...
test(
  "b6000102030405060708090a0b0c0d0e0f101112131415161718181819181a181b181c181d181e181f1820182118221823182418251826182718281829182a182b",
  {
    0: 1,
    2: 3,
    4: 5,
...
test(
  "b7000102030405060708090a0b0c0d0e0f101112131415161718181819181a181b181c181d181e181f1820182118221823182418251826182718281829182a182b182c182d",
  {
    0: 1,
    2: 3,
    4: 5,
...
test(
  "b818000102030405060708090a0b0c0d0e0f101112131415161718181819181a181b181c181d181e181f1820182118221823182418251826182718281829182a182b182c182d182e182f",
  {
    0: 1,
    2: 3,
    4: 5,
...
test("c012", 18);
test(
  "c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c012",
  18
); // multiple tags are fine
test(
  "c0c1c2c3c4c5c6c7c8c9cacbcccdcecdcf" +
    "d0d1d2d3d4d5d6d7" +
    "d812d91234da12345678db123456789abcdef0" +
    "12",
  18
);
test("c112", 18);
...
*/
test("f90000", 0);
test("f90001", 5.960464477539063e-8);
test("f9c400", -4);
test("f97c00", 1 / 0);
test("f97c01", 0 / 0);
test("f97fff", 0 / 0);
test("f98000", -0);
test("f98001", -5.960464477539063e-8);
test("f9fc00", -1 / 0);
test("f9fc01", 0 / 0);
test("f9ffff", 0 / 0);
// 0xfa: single
