...
tryEval(
  'obj = function (x) { return { get foo() { return 123; }, set foo(v) { print("set foo",v); } }; }(); print(obj.foo); obj.foo = 234;'
);
tryEval(
  'obj = function (x) { "use strict"; return { get foo() { return 123; }, set foo(v) { print("set foo",v); } }; }(); print(obj.foo); obj.foo = 234;'
);

// add a bit more challenge and make the setter / getter names are 'set' and 'get'
tryEval(
  'obj = function (x) { return { get set() { return 123; }, set set(v) { print("set set",v); } }; }(); print(obj.set); obj.set = 234;'
);
tryEval(
  'obj = function (x) { "use strict"; return { get set() { return 123; }, set set(v) { print("set set",v); } }; }(); print(obj.set); obj.set = 234;'
);
tryEval(
  'obj = function (x) { return { get get() { return 123; }, set get(v) { print("set get",v); } }; }(); print(obj.get); obj.get = 234;'
);
tryEval(
  'obj = function (x) { "use strict"; return { get get() { return 123; }, set get(v) { print("set get",v); } }; }(); print(obj.get); obj.get = 234;'
);
