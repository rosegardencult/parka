...
evalTest(
  'var obj = { foo: 123 }; var rc = delete obj.foo; print("foo" in obj); rc;'
);

// property reference, non-configurable properties cannot be deleted
// non-strict mode: false, strict mode: TypeError
evalTest(
  'var obj={}; Object.defineProperty(obj, "foo", { value: 123, writable: true, enumerable: true, configurable: false }); var rc = delete obj.foo; print("foo" in obj); rc;'
);
evalTest(
  '"use strict"; var obj={}; Object.defineProperty(obj, "foo", { value: 123, writable: true, enumerable: true, configurable: false }); var rc = delete obj.foo; print("foo" in obj); rc;'
);
...
evalTest(
  '(function () { eval("var x = 123;"); var rc = delete x; print(typeof x); return rc; })()'
);
evalTest(
  '(function () { "use strict"; eval("var x = 123;"); var rc = delete x; print(typeof x); return rc; })()'
);
