...
function computedPropertyName() {
  ...
  try {
    res = eval(
      '({ [ { valueOf: function () { print("valueOf 1"); return "valueof1"; }, toString: function () { print("toString 1"); return "tostring1"; } } ]: "value1", [ { valueOf: function () { print("valueOf 2"); return "valueof2"; }, toString: function () { print("toString 2"); return "tostring2"; } } ]: "value2" })'
    );
    print(JSON.stringify(res));
    print(res.valueof1);
    print(res.tostring1);
