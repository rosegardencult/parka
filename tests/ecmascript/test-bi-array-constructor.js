...
function asFunctionTest() {
  ...
  run(function() {
    p(Array(-1));
  }); // ToUint32(len) !== len -> RangeError
  run(function() {
    p(Array(256 * 256 * 256 * 256));
  });
  run(function() {
    p(Array(1.4));
  });
  ...
  run(function() {
    p(Array(Number.NEGATIVE_INFINITY));
  });
  run(function() {
    p(Array(Number.POSITIVE_INFINITY));
  });
...
function asConstructorTest() {
  ...
  run(function() {
    p(new Array(256 * 256 * 256 * 256));
  });
  run(function() {
    p(new Array(1.4));
  });
  run(function() {
    p(new Array(Number.NaN));
  });
  run(function() {
    p(new Array(Number.NEGATIVE_INFINITY));
  });
  run(function() {
    p(new Array(Number.POSITIVE_INFINITY));
  });
