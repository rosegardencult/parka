...
function testNonProxy() {
  ...
  function nnrapply_b() {
    return Reflect.apply(nnrapply_a, null, []);
  }
  nnrapply_b();
  ...
  function cccons_b() {
    return Reflect.construct(cccons_a, []);
  }
  new cccons_b();
  ...
  function nccons_b() {
    return Reflect.construct(nccons_a, []);
  }
  nccons_b();
  ...
  function cnrapply_b() {
    return Reflect.apply(cnrapply_a, null, []);
  }
  new cnrapply_b();
}
