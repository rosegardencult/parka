...
try {
  ...
  eval(
    "function func_arg2(a) { 'use strict'; print(a); print(delete a); print(a); }"
  );
  func_arg2(1);
} catch (e) {
  print(e.name);
...
try {
  eval(
    "function func_var1() { var a = 1; print(a); print(delete a); print(a); }"
  );
  func_var1();
} catch (e) {
  print(e.name);
...
try {
  eval(
    "function func_var2() { 'use strict'; var a = 1; print(a); print(delete a); print(a); }"
  );
  func_var2();
} catch (e) {
  print(e.name);
...
try {
  eval(
    "function func_fun1() { function a() {}; print(typeof a); print(delete a); print(typeof a); }"
  );
  func_fun1();
} catch (e) {
  print(e.name);
...
try {
  eval(
    "function func_fun2() { 'use strict'; function a() {}; print(typeof a); print(delete a); print(typeof a); }"
  );
  func_fun2();
} catch (e) {
  print(e.name);
...
try {
  eval(
    "function func_var_eval1() { eval('var a = 10'); print(a); print(delete(a)); print(a); };"
  );
  func_var_eval1();
} catch (e) {
  print(e.name);
...
try {
  eval(
    "function func_fun_eval1() { eval('function a() {}'); print(typeof a); print(delete(a)); print(typeof a); };"
  );
  func_fun_eval1();
} catch (e) {
...
try {
  eval(
    "function arguments_mutability2() {\n" +
      "    'use strict';\n" +
      "    print(typeof arguments);\n" +
      "    arguments = 1;\n" +
      "    print(typeof arguments);\n" +
