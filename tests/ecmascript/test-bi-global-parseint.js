...
function numbersNear53BitsTest() {
  ...
  print("(parse radix 2)");
  print(
    g.parseInt("100000000000000000000000000000000000000000000000000000", 2)
  );
  print(
    g.parseInt("100000000000000000000000000000000000000000000000000001", 2)
  );
  print(
    g.parseInt("100000000000000000000000000000000000000000000000000010", 2)
  );
  print(
    g.parseInt("100000000000000000000000000000000000000000000000000011", 2)
  );
  print(
    g.parseInt("100000000000000000000000000000000000000000000000000100", 2)
  );
  print(
    g.parseInt("100000000000000000000000000000000000000000000000000101", 2)
  );
  print(
    g.parseInt("100000000000000000000000000000000000000000000000000110", 2)
  );
  print(
    g.parseInt("100000000000000000000000000000000000000000000000000111", 2)
  );
  print(
    g.parseInt("100000000000000000000000000000000000000000000000001000", 2)
  );
...
function largeNumberTest() {
  var inputs = [
    ...
    },
    {
      base: 3,
      str:
        "202201102121002021012000211012011021221022212021111001022110211020010021100121011"
    },
    {
      base: 4,
    ...
    {
      base: 5,
      str: "11031110441201303134210404233413032443021130230130231311"
    },
