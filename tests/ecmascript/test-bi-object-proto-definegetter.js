...
function testDefineGetter() {
  ...
  // Basic case.
  obj.__defineGetter__("foo", function returnBar() {
    return "BAR";
  });
  print(obj.foo);
  ...
  Object.prototype.__defineGetter__(123, function returnQuux() {
    return "QUUX";
  });
  print(obj["123"]);
  print(Object.prototype["123"]);
  obj.__defineGetter__(void 0, function returnBar() {
    return "BAR";
  });
  print(obj.undefined);
  obj.__defineGetter__(null, function returnBar() {
    return "BAR";
  });
  print(obj.null);
  obj.__defineGetter__({}, function returnBar() {
    return "BAR";
  });
  ...
  try {
    obj.__defineGetter__("abc", function returnBar() {
      return "BAR";
    });
    print("never here");
  } catch (e) {
