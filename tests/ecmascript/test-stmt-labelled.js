...
function basicSyntaxTest() {
  ...
  label_variable: var test = 123;

  print("label empty");
  label_empty:;

  print("label expression");
  label_expression: 1 + 2;
  ...
  label_iteration_dowhile: do {} while (0);
  label_iteration_while: while (0) {}
  label_iteration_for1: for (i = 0; i < 10; i++) {}
  label_iteration_for2: for (var j = 0; j < 10; j++) {}
  label_iteration_for3: for (i in [1, 2, 3]) {
  }
  label_iteration_for4: for (var k in [4, 5, 6]) {
  }
  ...
  print("label return");
  (function returntest() {
    label_return: return 123;
  })();

  print("label with");
  label_with: with ({ foo: 123 }) {
    print(foo);
  }

  print("label switch");
  label_switch: switch (123) {
  }

  print("label throw");
  try {
    label_throw: throw "myerror";
  } catch (e) {
    print(e);
  }
  ...
  label_debugger: debugger;

  print("label another label");
  label_label1: label_label2: label_label3: print("multi-labelled statement");
