...
function symbolPropertyTest() {
  ...
  Object.defineProperty(obj, o2, {
    value: Object(Symbol.for("123")),
    configurable: true
  });
  pd = Object.getOwnPropertyDescriptor(obj, s2);
  print(typeof pd, typeof pd.value, pd.value == Symbol.for("123"));
  ...
  Object.defineProperties(obj, {
    ...
    [Object(Symbol.for("K4"))]: {
      value: Object(Symbol.for("V4")),
      configurable: true
    }
  });
  ...
  pd = Reflect.getOwnPropertyDescriptor(obj, s2);
  print(typeof pd, typeof pd.value, pd.value === "baz");
  Reflect.defineProperty(obj, s2, {
    value: Symbol.for("123"),
    configurable: true
  });
  pd = Reflect.getOwnPropertyDescriptor(obj, s2);
  print(typeof pd, typeof pd.value, pd.value === Symbol.for("123"));
  Reflect.defineProperty(obj, o2, {
    value: Object(Symbol.for("123")),
    configurable: true
  });
  pd = Reflect.getOwnPropertyDescriptor(obj, s2);
  ...
  Object.defineProperty(obj, Symbol.for("accessor"), {
    ...
    set: function(v) {
      print("SETTER called", typeof v, v);
    }
  });
