...
index 6: TypeError: nativefunction required, found [object Object] (stack index
6) index 7: TypeError: nativefunction required, found (0xdeadbeef) (stack index
7) index 8, my_func 1, dummy_func: 0 index 9, my_func 0, dummy_func: 1 final
top: 9
...
static duk_ret_t safe_helper(duk_context* ctx, void* udata) {
  ...
  printf("index %ld, my_func %d, dummy_func: %d\n", (long)idx,
         (funcptr == my_func), (funcptr == dummy_func));
  return 0;
}
