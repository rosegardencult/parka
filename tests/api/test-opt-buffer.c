static duk_ret_t safe_helper1(duk_context* ctx, void* udata) {
  ...
  buf = duk_opt_buffer(ctx, idx, &len, (void*)0x1357acefUL,
                       (duk_size_t)0x87654321UL);

  printf("index %ld: length %lu, ptr-is-NULL %d, ptr-is-0x1357acef %d\n",
         (long)idx, (unsigned long)len, (buf == NULL ? 1 : 0),
         (buf == 0x1357acefUL));
  return 0;
}
...
static duk_ret_t safe_helper2(duk_context* ctx, void* udata) {
  ...
  buf = duk_opt_buffer(ctx, idx, NULL, (void*)0x1357acefUL,
                       (duk_size_t)0x87654321UL);

  printf("index %ld: ptr-is-NULL %d, ptr-is-0x1357acef %d\n", (long)idx,
         (buf == NULL ? 1 : 0), (buf == 0x1357acefUL));
  return 0;
}
...
index 12: TypeError: buffer required, found [object ArrayBuffer] (stack index
12) index 12: TypeError: buffer required, found [object ArrayBuffer] (stack
index 12) index 13: TypeError: buffer required, found [object Uint32Array]
(stack index 13) index 13: TypeError: buffer required, found [object
Uint32Array] (stack index 13) index 14: TypeError: buffer required, found
[object DataView] (stack index 14) index 14: TypeError: buffer required, found
[object DataView] (stack index 14) index 15: TypeError: buffer required, found
[object Uint32Array] (stack index 15) index 15: TypeError: buffer required,
found [object Uint32Array] (stack index 15) index 16: TypeError: buffer
required, found [object Uint8Array] (stack index 16) index 16: TypeError: buffer
required, found [object Uint8Array] (stack index 16) index 17: TypeError: buffer
required, found [object Uint8Array] (stack index 17) index 17: TypeError: buffer
required, found [object Uint8Array] (stack index 17) index 18: length
2271560481, ptr-is-NULL 0, ptr-is-0x1357acef 1 index 18: ptr-is-NULL 0,
ptr-is-0x1357acef 1 final top: 18
...
static duk_ret_t test_basic(duk_context* ctx, void* udata) {
  ...
  duk_eval_string(
      ctx, "(function () { return new DataView(new ArrayBuffer(16)); })()");
  duk_eval_string(
      ctx, "(function () { return new Uint32Array(16).subarray(3, 6); })()");
  duk_eval_string(ctx, "(function () { return new Buffer('ABCDEFGH'); })()");
  duk_eval_string(
      ctx, "(function () { return new Buffer('ABCDEFGH').slice(3, 6); })()");
