...
static const duk_number_list_entry my_consts[] = {
    {"FLAG_FOO", (duk_double_t)(1 << 0)},  {"FLAG_BAR", (duk_double_t)(1 << 1)},
    {"FLAG_QUUX", (duk_double_t)(1 << 2)}, {"meaning", (duk_double_t)42.0},
    {"nonFast", (duk_double_t)42.1},       {NULL, 0.0}};
...
static duk_ret_t test_1(duk_context* ctx, void* udata) {
  ...
  duk_eval_string_noresult(
      ctx,
      "print(Duktape.info(MyModule.meaning).itag === "
      "Duktape.info(MyModule.FLAG_FOO).itag)\n" /* match: both are fastints */
      "print(Duktape.info(MyModule.meaning).itag !== "
      "Duktape.info(MyModule.nonFast).itag)\n" /* no match: nonFast is not
                                                  fastint */
  );
