...
push done
result:

===*/
...
void test(duk_context* ctx) {
  const char* fmt =
      "%d%d%d%d%d%d%d%d" CHARS40 CHARS40 CHARS40 CHARS40 CHARS40 CHARS40;
  ...
  duk_push_sprintf(ctx, fmt, 12345, 23456, 12345, 23456, 12345, 23456, 12345,
                   23456);
