...
rc=1, result='TypeError: undefined not callable (property [object Object] of
[object Object])'
==> rc=0, result='undefined'
*** test_9 (duk_safe_call)
==> rc=1, result='TypeError: invalid args'
*** test_10 (duk_safe_call)
rc=1, result='TypeError: undefined not callable (property 'bar' of [object
Object])'
==> rc=0, result='undefined'
final top: 0
===*/
...
static duk_ret_t test_1(duk_context* ctx, void* udata) {
  ...
  duk_eval_string(ctx,
                  "({ name: 'me', foo: function (x,y) { print(this.name); "
                  "return x+y; } })"); /* idx 1 */
...
static duk_ret_t test_2(duk_context* ctx, void* udata) {
  ...
  /* use plain number as 'this', add function to Number.prototype; non-strict
   * handler causes this to be coerced to Number.
   */
  duk_eval_string(ctx,
                  "Number.prototype.func_nonstrict = function (x,y) { "
                  "print(typeof this, this); return x+y; };");
...
static duk_ret_t test_3(duk_context* ctx, void* udata) {
  ...
  /* use plain number as 'this', add function to Number.prototype; strict
   * handler causes this to remain a plain number.
   */
  duk_eval_string(ctx,
                  "Number.prototype.func_strict = function (x,y) { 'use "
                  "strict'; print(typeof this, this); return x+y; };");
  duk_pop(ctx);           /* pop result */
  duk_push_int(ctx, 123); /* obj */
...
static duk_ret_t test_4(duk_context* ctx, void* udata) {
  ...
  /* basic error case */
  duk_eval_string(ctx,
                  "({ name: 'me', foo: function (x,y) { throw new Error('my "
                  "error'); } })"); /* idx 1 */
  duk_push_string(ctx, "foo");
  duk_push_int(ctx, 10);
  duk_push_int(ctx, 11);
...
static duk_ret_t test_6(duk_context* ctx, void* udata) {
  ...
  duk_eval_string(ctx,
                  "({ get prop() { throw new RangeError('getter error'); } })");
...
static duk_ret_t test_8(duk_context* ctx, void* udata) {
  ...
  /* invalid arg count, causes 'key' to be identified with the object in the
   * stack */
