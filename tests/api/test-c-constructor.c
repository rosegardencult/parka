...
static duk_ret_t my_constructor(duk_context* ctx) { return 0; }
...
static duk_ret_t test_1(duk_context* ctx, void* udata) {
  ...
  duk_put_prop_string(
      ctx, -2, "inherited"); /* set proto.inherited = "inherited value" */
  duk_put_prop_string(
      ctx, -2,
      "prototype"); /* set cons.prototype = proto; stack -> [ global cons ] */
  duk_put_prop_string(ctx, -2, "MyConstructor"); /* set global.MyConstructor =
                                                    cons; stack -> [ global ] */
  duk_pop(ctx);
