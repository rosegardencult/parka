...
static void test_one_flags(duk_context* ctx, duk_uint_t defprop_flags) {
  ...
  duk_def_prop(ctx, -3,
               DUK_DEFPROP_HAVE_VALUE | DUK_DEFPROP_FORCE | defprop_flags);
  dump_prop(ctx);
  duk_pop(ctx);

  duk_eval_string(ctx,
                  "(function () { var o = {}; Object.defineProperty(o, 'prop', "
                  "{value:-123,writable:true,enumerable:true,configurable:true}"
                  "); return o; })()");
  duk_push_string(ctx, "prop");
  duk_push_uint(ctx, 123);
  ...
  duk_eval_string(ctx,
                  "(function () { var o = {}; Object.defineProperty(o, 'prop', "
                  "{value:-123,writable:false,enumerable:false,configurable:"
                  "false}); return o; })()");
  duk_push_string(ctx, "prop");
  duk_push_uint(ctx, 123);
  duk_def_prop(ctx, -3,
