...
static duk_ret_t test_1(duk_context* ctx, void* udata) {
  ...
  duk_eval_string(
      ctx, "({ myfunc: function(x,y,z) { print(this); return x+y+z; } })");
...
static duk_ret_t test_2(duk_context* ctx, void* udata) {
  ...
  duk_eval_string(ctx,
                  "({ myfunc: function(x,y,z) { print(this); throw new "
                  "Error('my error'); } })");
  duk_push_string(ctx, "myfunc");
  duk_push_int(ctx, 10);
  duk_push_int(ctx, 11);
...
static duk_ret_t test_3(duk_context* ctx, void* udata) {
  ...
  duk_eval_string(ctx,
                  "Number.prototype.myfunc1 = function() { print(typeof this, "
                  "this, Object.prototype.toString.call(this)); };");
  duk_pop(ctx);
  duk_eval_string(
      ctx,
      "Number.prototype.myfunc2 = function() { 'use strict'; print(typeof "
      "this, this, Object.prototype.toString.call(this)); };");
  duk_pop(ctx);
