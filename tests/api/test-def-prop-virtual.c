...
static duk_ret_t test__array_length_enumerable(duk_context* ctx, int force) {
  ...
  fflush(stdout);
  duk_def_prop(ctx, -2,
               DUK_DEFPROP_SET_ENUMERABLE | (force ? DUK_DEFPROP_FORCE : 0));

  duk_eval_string(ctx,
                  "(function (v) { print(Duktape.enc('jx', "
...
static duk_ret_t test_array_length_enumerable_noforce(duk_context* ctx,
                                                      void* udata) {
  (void)udata;
  return test__array_length_enumerable(ctx, 0);
}
static duk_ret_t test_array_length_enumerable_force(duk_context* ctx,
                                                    void* udata) {
  (void)udata;
...
static duk_ret_t test__array_length_configurable(duk_context* ctx, int force) {
  ...
  fflush(stdout);
  duk_def_prop(ctx, -2,
               DUK_DEFPROP_SET_CONFIGURABLE | (force ? DUK_DEFPROP_FORCE : 0));
...
static duk_ret_t test_array_length_configurable_noforce(duk_context* ctx,
                                                        void* udata) {
  (void)udata;
  return test__array_length_configurable(ctx, 0);
}
static duk_ret_t test_array_length_configurable_force(duk_context* ctx,
                                                      void* udata) {
  (void)udata;
  return test__array_length_configurable(ctx, 1);
}

static duk_ret_t test__length_overwrite(duk_context* ctx, int force,
                                        int new_len) {
  duk_eval_string(
      ctx,
      "(function () {\n"
  ...
  duk_def_prop(ctx, -3,
               DUK_DEFPROP_HAVE_VALUE | (force ? DUK_DEFPROP_FORCE : 0));
...
static duk_ret_t test_array_length_overwrite_same_noforce(duk_context* ctx,
                                                          void* udata) {
  (void)udata;
  return test__length_overwrite(ctx, 0, 3);
}
static duk_ret_t test_array_length_overwrite_same_force(duk_context* ctx,
                                                        void* udata) {
  (void)udata;
  return test__length_overwrite(ctx, 1, 3);
}
static duk_ret_t test_array_length_overwrite_bigger_noforce(duk_context* ctx,
                                                            void* udata) {
  (void)udata;
  return test__length_overwrite(ctx, 0, 5);
}
static duk_ret_t test_array_length_overwrite_bigger_force(duk_context* ctx,
                                                          void* udata) {
  (void)udata;
  return test__length_overwrite(ctx, 1, 5);
}
static duk_ret_t test_array_length_overwrite_smaller_noforce(duk_context* ctx,
                                                             void* udata) {
  (void)udata;
  return test__length_overwrite(ctx, 0, 1);
}
static duk_ret_t test_array_length_overwrite_smaller_force(duk_context* ctx,
                                                           void* udata) {
  (void)udata;
