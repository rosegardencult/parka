...
static void register_dump_buffer_info(duk_context* ctx) {
  duk_eval_string_noresult(
      ...
      "    if (p === ArrayBuffer.prototype) { "
      "prot.push('ArrayBuffer.prototype'); }\n"
      ...
      "prot.push('Uint8Array.prototype'); }\n"
      "    if (p === Uint8ClampedArray.prototype) { "
      "prot.push('Uint8ClampedArray.prototype'); }\n"
      "    if (p === Int16Array.prototype) { "
      "prot.push('Int16Array.prototype'); }\n"
      "    if (p === Uint16Array.prototype) { "
      "prot.push('Uint16Array.prototype'); }\n"
      "    if (p === Int32Array.prototype) { "
      "prot.push('Int32Array.prototype'); }\n"
      "    if (p === Uint32Array.prototype) { "
      "prot.push('Uint32Array.prototype'); }\n"
      "    if (p === Float32Array.prototype) { "
      "prot.push('Float32Array.prototype'); }\n"
      "    if (p === Float64Array.prototype) { "
      "prot.push('Float64Array.prototype'); }\n"

      "    print(typeof v, Object.prototype.toString.call(v), v.length, "
      "v.byteOffset, v.byteLength, v.BYTES_PER_ELEMENT, typeof v.buffer);\n"
      "    print(v instanceof Buffer, v instanceof ArrayBuffer, v instanceof "
      "DataView, v instanceof Int8Array, v instanceof Uint8Array, v instanceof "
      "Uint8ClampedArray, v instanceof Int16Array, v instanceof Uint16Array, v "
      "instanceof Int32Array, v instanceof Uint32Array, v instanceof "
      "Float32Array, v instanceof Float64Array, '->', instof.join(','));\n"
      "    print(p === Buffer.prototype, p === ArrayBuffer.prototype, p === "
      "DataView.prototype, p === Int8Array.prototype, p === "
      "Uint8Array.prototype, p === Uint8ClampedArray.prototype, p === "
      "Int16Array.prototype, p === Uint16Array.prototype, p === "
      "Int32Array.prototype, p === Uint32Array.prototype, p === "
      "Float32Array.prototype, p === Float64Array.prototype, '->', "
      "prot.join(','));\n"
      "}");
}
...
Buffer,Uint8Array true false false false false false false false false false
false false -> Buffer.prototype object [object ArrayBuffer] undefined undefined
32 undefined undefined false true false false false false false false false
false false false -> ArrayBuffer false true false false false false false false
false false false false -> ArrayBuffer.prototype object [object DataView]
undefined 128 32 undefined object false false true false false false false false
false false false false -> DataView false false true false false false false
false false false false false -> DataView.prototype object [object Int8Array] 32
128 32 1 object false false false true false false false false false false false
false -> Int8Array false false false true false false false false false false
false false -> Int8Array.prototype object [object Uint8Array] 32 128 32 1 object
false false false false true false false false false false false false ->
Uint8Array false false false false true false false false false false false
false -> Uint8Array.prototype object [object Uint8ClampedArray] 32 128 32 1
object false false false false false true false false false false false false ->
Uint8ClampedArray false false false false false true false false false false
false false -> Uint8ClampedArray.prototype object [object Int16Array] 16 128 32
2 object false false false false false false true false false false false false
-> Int16Array false false false false false false true false false false false
false -> Int16Array.prototype object [object Uint16Array] 16 128 32 2 object
false false false false false false false true false false false false ->
Uint16Array false false false false false false false true false false false
false -> Uint16Array.prototype object [object Int32Array] 8 128 32 4 object
false false false false false false false false true false false false ->
Int32Array false false false false false false false false true false false
false -> Int32Array.prototype object [object Uint32Array] 8 128 32 4 object
false false false false false false false false false true false false ->
Uint32Array false false false false false false false false false true false
false -> Uint32Array.prototype object [object Float32Array] 8 128 32 4 object
false false false false false false false false false false true false ->
Float32Array false false false false false false false false false false true
false -> Float32Array.prototype object [object Float64Array] 4 128 32 8 object
false false false false false false false false false false false true ->
Float64Array false false false false false false false false false false false
true -> Float64Array.prototype final top: 0
==> rc=0, result='undefined'
===*/

static duk_ret_t test_basic(duk_context* ctx, void* udata) {
  duk_uint_t test[] = {
      DUK_BUFOBJ_NODEJS_BUFFER, DUK_BUFOBJ_ARRAYBUFFER,
      DUK_BUFOBJ_DATAVIEW,      DUK_BUFOBJ_INT8ARRAY,
      DUK_BUFOBJ_UINT8ARRAY,    DUK_BUFOBJ_UINT8CLAMPEDARRAY,
      DUK_BUFOBJ_INT16ARRAY,    DUK_BUFOBJ_UINT16ARRAY,
      DUK_BUFOBJ_INT32ARRAY,    DUK_BUFOBJ_UINT32ARRAY,
      DUK_BUFOBJ_FLOAT32ARRAY,  DUK_BUFOBJ_FLOAT64ARRAY,
  };
  int i;
...
ArrayBuffer false true false false false false false false false false false
false -> ArrayBuffer.prototype object [object Uint32Array] 2 20 8 4 object false
false false false false false false false false true false false -> Uint32Array
false false false false false false false false false true false false ->
Uint32Array.prototype buf: 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 bb bb
bb bb cc cc cc cc dd dd dd dd bb bb 00 00 final top: 3
==> rc=0, result='undefined'
...
==> rc=1, result='TypeError: buffer required, found [object ArrayBuffer] (stack
index -1)'
===*/

static duk_ret_t test_arraybuffer_base_for_u32array(duk_context* ctx,
                                                    void* udata) {
  unsigned char* buf;
  int i;
  ...
  /* Modify ArrayBuffer. */
  duk_eval_string(ctx,
                  "(function (b) { var u8 = new Uint8Array(b); for (var i = 0; "
                  "i < b.byteLength; i++) { u8[i] = 0xbb; } })");
  duk_dup(ctx, -2);
  duk_call(ctx, 1);
  duk_pop(ctx);
  ...
  /* Modify Uint32Array. */
  duk_eval_string(ctx,
                  "(function (v) { v[0] = 0xcccccccc; v[1] = 0xdddddddd; })");
  duk_dup(ctx, -2);
  duk_call(ctx, 1);
  duk_pop(ctx);
...
static duk_ret_t test_arraybuffer_base_for_u32array_ecma(duk_context* ctx,
                                                         void* udata) {
  unsigned char* buf;
  int i;
...
static duk_ret_t test_arraybuffer_base_for_arraybuffer(duk_context* ctx,
                                                       void* udata) {
  (void)udata;
...
false false false false true false false false false false false false ->
Uint8Array false false false false true false false false false false false
false -> Uint8Array.prototype 22 16 22
1
[object ArrayBuffer]
...
false true false false false false false false false false false false ->
ArrayBuffer false true false false false false false false false false false
false -> ArrayBuffer.prototype undefined undefined 38 undefined undefined 123
123 extbuf[16 + 3] = 123 final top: 1
==> rc=0, result='undefined'
===*/
...
static duk_ret_t test_view_buffer_prop(duk_context* ctx, void* udata) {
  ...
  duk_eval_string(
      ...
      "    print(v.buffer);\n"
      "    pd = Object.getOwnPropertyDescriptor(v.__proto__.__proto__, "
      "'buffer');\n"
      "    print(typeof pd.get, typeof pd.set, pd.enumerable, "
      "pd.configurable);\n"
...
false false false false false false false false false true false false ->
Uint32Array false false false false false false false false false true false
false -> Uint32Array.prototype final top: 0
==> rc=0, result='undefined'
===*/
...
==> rc=1, result='TypeError: buffer required, found none (stack index
-2147483648)'
===*/
...
static duk_ret_t test_invalid_index2(duk_context* ctx, void* udata) {
  ...
  duk_push_fixed_buffer(ctx, 256);
  duk_push_buffer_object(ctx, DUK_INVALID_INDEX, 7, 512,
...
==> rc=1, result='TypeError: buffer required, found [object Uint16Array] (stack
index -1)'
...
static duk_ret_t test_invalid_flags1(duk_context* ctx, void* udata) {
  ...
  duk_push_buffer_object(
      ctx, -1, 7, 512,
      0 /* no type given, but matches DUK_BUFOBJ_ARRAYBUFFER */);
  printf("final top: %ld\n", (long)duk_get_top(ctx));
  return 0;
}
...
static duk_ret_t test_invalid_flags2(duk_context* ctx, void* udata) {
  ...
  duk_push_fixed_buffer(ctx, 256);
  duk_push_buffer_object(ctx, -1, 7, 512,
                         (duk_uint_t)0xdeadbeefUL /* ERROR: bogus type */);
  printf("final top: %ld\n", (long)duk_get_top(ctx));
  return 0;
}
...
static duk_ret_t test_invalid_flags3(duk_context* ctx, void* udata) {
  ...
  duk_push_buffer_object(
      ctx, -1, 7, 512,
      (duk_uint_t)(DUK_BUFOBJ_FLOAT64ARRAY +
                   1) /* ERROR: bogus type, right after last defined */);
  printf("final top: %ld\n", (long)duk_get_top(ctx));
  return 0;
}
...
static duk_ret_t test_invalid_offlen_wrap1(duk_context* ctx, void* udata) {
  ...
  duk_push_fixed_buffer(ctx, 256);
  duk_push_buffer_object(ctx, -1, (duk_size_t)(duk_uint_t)-100, 1000,
...
static duk_ret_t test_invalid_offlen_wrap2(duk_context* ctx, void* udata) {
  ...
  duk_push_fixed_buffer(ctx, 256);
  duk_push_buffer_object(ctx, -1, (duk_size_t)(duk_uint_t)-100, 100,
                         DUK_BUFOBJ_UINT8ARRAY);
  printf("final top: %ld\n", (long)duk_get_top(ctx));
  return 0;
}
...
false false false false true false false false false false false false ->
Uint8Array false false false false true false false false false false false
false -> Uint8Array.prototype final top: 1
==> rc=0, result='undefined'
===*/
...
static duk_ret_t test_allowed_offlen_nowrap1(duk_context* ctx, void* udata) {
  ...
  duk_push_fixed_buffer(ctx, 256);
  duk_push_buffer_object(ctx, -1, (duk_size_t)(duk_uint_t)-100, 99,
                         DUK_BUFOBJ_UINT8ARRAY);
  duk_eval_string(ctx, "dumpBufferInfo");
  duk_dup(ctx, -2);
  duk_call(ctx, 1);
