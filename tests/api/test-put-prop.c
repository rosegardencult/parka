...
static duk_ret_t test_ex_accessor_wo_setter_safecall(duk_context* ctx,
                                                     void* udata) {
  (void)udata;
...
static duk_ret_t test_ex_setter_throws(duk_context* ctx) {
  ...
  src =
      ...
      "        extensible: true,\n"
      "        get: function() { print('getter'); },\n"
      "        set: function() { print('setter, throw error'); throw 'setter "
      "error' }\n"
      "    });\n"
      "    return o;\n"
      "})()";
...
static duk_ret_t test_new_not_extensible(duk_context* ctx) {
  ...
  src =
      "(function () { var o = { foo: 1 }; Object.preventExtensions(o); return "
      "o; })()";
...
static duk_ret_t test_new_not_extensible_safecall(duk_context* ctx,
                                                  void* udata) {
  (void)udata;
...
static duk_ret_t test_putprop_shorthand_a(duk_context* ctx) {
  ...
  duk_push_string(
      ctx,
      "DUMMY"); /* just to ensure 'heapptr' is not used based on position */
  duk_push_uint(ctx, 456);
  duk_put_prop_heapptr(ctx, -4, ptr);
  duk_pop_2(ctx);

  duk_eval_string(ctx,
                  "({ toString: function () { return 'stringCoerced'; } })");
  ptr = duk_require_heapptr(ctx, -1);
  duk_push_string(
      ctx,
      "DUMMY"); /* just to ensure 'heapptr' is not used based on position */
...
static duk_ret_t test_putprop_shorthand_a_safecall(duk_context* ctx,
                                                   void* udata) {
  (void)udata;
...
static duk_ret_t test_putprop_string_invalid_index1(duk_context* ctx,
                                                    void* udata) {
  (void)udata;
...
static duk_ret_t test_putprop_string_invalid_index2(duk_context* ctx,
                                                    void* udata) {
  (void)udata;
...
static duk_ret_t test_putprop_lstring_invalid_index1(duk_context* ctx,
                                                     void* udata) {
  (void)udata;
...
static duk_ret_t test_putprop_lstring_invalid_index2(duk_context* ctx,
                                                     void* udata) {
  (void)udata;
...
static duk_ret_t test_putprop_literal_invalid_index1(duk_context* ctx,
                                                     void* udata) {
  (void)udata;
...
static duk_ret_t test_putprop_literal_invalid_index2(duk_context* ctx,
                                                     void* udata) {
  (void)udata;
...
static duk_ret_t test_putprop_index_invalid_index1(duk_context* ctx,
                                                   void* udata) {
  (void)udata;
...
static duk_ret_t test_putprop_index_invalid_index2(duk_context* ctx,
                                                   void* udata) {
  (void)udata;
...
static duk_ret_t test_putprop_heapptr_invalid_index1(duk_context* ctx,
                                                     void* udata) {
  void* ptr;
...
static duk_ret_t test_putprop_heapptr_invalid_index2(duk_context* ctx,
                                                     void* udata) {
  (void)udata;
