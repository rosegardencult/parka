...
#    define DUK_HEAP_STRING_UC_SYMBOL(heap) \
      DUK_HEAP_GET_STRING((heap), DUK_STRIDX_UC_SYMBOL)
#    define DUK_HTHREAD_STRING_UC_SYMBOL(thr) \
...
#    define DUK_HEAP_STRING_UC_ARRAY(heap) \
      DUK_HEAP_GET_STRING((heap), DUK_STRIDX_UC_ARRAY)
#    define DUK_HTHREAD_STRING_UC_ARRAY(thr) \
...
#    define DUK_HEAP_STRING_UC_DATE(heap) \
      DUK_HEAP_GET_STRING((heap), DUK_STRIDX_UC_DATE)
#    define DUK_HTHREAD_STRING_UC_DATE(thr) \
      DUK_HTHREAD_GET_STRING((thr), DUK_STRIDX_UC_DATE)
...
#    define DUK_HEAP_STRING_FLAGS(heap) \
      DUK_HEAP_GET_STRING((heap), DUK_STRIDX_FLAGS)
#    define DUK_HTHREAD_STRING_FLAGS(thr) \
      DUK_HTHREAD_GET_STRING((thr), DUK_STRIDX_FLAGS)
...
#    define DUK_HEAP_STRING_LC_SYMBOL(heap) \
      DUK_HEAP_GET_STRING((heap), DUK_STRIDX_LC_SYMBOL)
#    define DUK_HTHREAD_STRING_LC_SYMBOL(thr) \
      DUK_HTHREAD_GET_STRING((thr), DUK_STRIDX_LC_SYMBOL)
...
#    define DUK_HEAP_STRING_APPLY(heap) \
      DUK_HEAP_GET_STRING((heap), DUK_STRIDX_APPLY)
#    define DUK_HTHREAD_STRING_APPLY(thr) \
      DUK_HTHREAD_GET_STRING((thr), DUK_STRIDX_APPLY)
#    define DUK_STRIDX_CONSTRUCT 71 /* 'construct' */
#    define DUK_HEAP_STRING_CONSTRUCT(heap) \
      DUK_HEAP_GET_STRING((heap), DUK_STRIDX_CONSTRUCT)
#    define DUK_HTHREAD_STRING_CONSTRUCT(thr) \
      DUK_HTHREAD_GET_STRING((thr), DUK_STRIDX_CONSTRUCT)
...
#    define DUK_STRIDX_WELLKNOWN_SYMBOL_TO_PRIMITIVE \
      76 /* '\x81Symbol.toPrimitive\xff' */
#    define DUK_HEAP_STRING_WELLKNOWN_SYMBOL_TO_PRIMITIVE(heap) \
      DUK_HEAP_GET_STRING((heap), DUK_STRIDX_WELLKNOWN_SYMBOL_TO_PRIMITIVE)
#    define DUK_HTHREAD_STRING_WELLKNOWN_SYMBOL_TO_PRIMITIVE(thr) \
      DUK_HTHREAD_GET_STRING((thr), DUK_STRIDX_WELLKNOWN_SYMBOL_TO_PRIMITIVE)
#    define DUK_STRIDX_WELLKNOWN_SYMBOL_HAS_INSTANCE \
      77 /* '\x81Symbol.hasInstance\xff' */
#    define DUK_HEAP_STRING_WELLKNOWN_SYMBOL_HAS_INSTANCE(heap) \
      DUK_HEAP_GET_STRING((heap), DUK_STRIDX_WELLKNOWN_SYMBOL_HAS_INSTANCE)
#    define DUK_HTHREAD_STRING_WELLKNOWN_SYMBOL_HAS_INSTANCE(thr) \
      DUK_HTHREAD_GET_STRING((thr), DUK_STRIDX_WELLKNOWN_SYMBOL_HAS_INSTANCE)
#    define DUK_STRIDX_WELLKNOWN_SYMBOL_TO_STRING_TAG \
      78 /* '\x81Symbol.toStringTag\xff' */
#    define DUK_HEAP_STRING_WELLKNOWN_SYMBOL_TO_STRING_TAG(heap) \
      DUK_HEAP_GET_STRING((heap), DUK_STRIDX_WELLKNOWN_SYMBOL_TO_STRING_TAG)
#    define DUK_HTHREAD_STRING_WELLKNOWN_SYMBOL_TO_STRING_TAG(thr) \
      DUK_HTHREAD_GET_STRING((thr), DUK_STRIDX_WELLKNOWN_SYMBOL_TO_STRING_TAG)
#    define DUK_STRIDX_WELLKNOWN_SYMBOL_IS_CONCAT_SPREADABLE \
      79 /* '\x81Symbol.isConcatSpreadable\xff' */
#    define DUK_HEAP_STRING_WELLKNOWN_SYMBOL_IS_CONCAT_SPREADABLE(heap) \
      DUK_HEAP_GET_STRING((heap),                                       \
                          DUK_STRIDX_WELLKNOWN_SYMBOL_IS_CONCAT_SPREADABLE)
#    define DUK_HTHREAD_STRING_WELLKNOWN_SYMBOL_IS_CONCAT_SPREADABLE(thr) \
...
DUK_INTERNAL_DECL duk_ret_t
duk_bi_object_constructor_keys_shared(duk_context* ctx);
...
DUK_INTERNAL_DECL duk_ret_t
duk_bi_object_prototype_defineaccessor(duk_context* ctx);
DUK_INTERNAL_DECL duk_ret_t
duk_bi_object_prototype_lookupaccessor(duk_context* ctx);
DUK_INTERNAL_DECL duk_ret_t
duk_bi_function_prototype_to_string(duk_context* ctx);
...
DUK_INTERNAL_DECL duk_ret_t
duk_bi_function_prototype_hasinstance(duk_context* ctx);
...
DUK_INTERNAL_DECL duk_ret_t
duk_bi_array_prototype_join_shared(duk_context* ctx);
...
DUK_INTERNAL_DECL duk_ret_t
duk_bi_array_prototype_indexof_shared(duk_context* ctx);
DUK_INTERNAL_DECL duk_ret_t
duk_bi_array_prototype_iter_shared(duk_context* ctx);
DUK_INTERNAL_DECL duk_ret_t
duk_bi_array_prototype_reduce_shared(duk_context* ctx);
DUK_INTERNAL_DECL duk_ret_t
duk_bi_string_constructor_from_char_code(duk_context* ctx);
DUK_INTERNAL_DECL duk_ret_t
duk_bi_string_constructor_from_code_point(duk_context* ctx);
...
DUK_INTERNAL_DECL duk_ret_t
duk_bi_string_prototype_char_code_at(duk_context* ctx);
DUK_INTERNAL_DECL duk_ret_t duk_bi_string_prototype_concat(duk_context* ctx);
DUK_INTERNAL_DECL duk_ret_t
duk_bi_string_prototype_indexof_shared(duk_context* ctx);
DUK_INTERNAL_DECL duk_ret_t
duk_bi_string_prototype_locale_compare(duk_context* ctx);
...
DUK_INTERNAL_DECL duk_ret_t
duk_bi_string_prototype_startswith_endswith(duk_context* ctx);
...
DUK_INTERNAL_DECL duk_ret_t
duk_bi_number_prototype_to_exponential(duk_context* ctx);
DUK_INTERNAL_DECL duk_ret_t
duk_bi_number_prototype_to_precision(duk_context* ctx);
...
DUK_INTERNAL_DECL duk_ret_t
duk_bi_date_prototype_tostring_shared(duk_context* ctx);
...
DUK_INTERNAL_DECL duk_ret_t
duk_bi_regexp_prototype_shared_getter(duk_context* ctx);
DUK_INTERNAL_DECL duk_ret_t
duk_bi_error_prototype_stack_getter(duk_context* ctx);
DUK_INTERNAL_DECL duk_ret_t
duk_bi_error_prototype_stack_setter(duk_context* ctx);
DUK_INTERNAL_DECL duk_ret_t
duk_bi_error_prototype_filename_getter(duk_context* ctx);
DUK_INTERNAL_DECL duk_ret_t
duk_bi_error_prototype_filename_setter(duk_context* ctx);
DUK_INTERNAL_DECL duk_ret_t
...
DUK_INTERNAL_DECL duk_ret_t
duk_bi_reflect_object_delete_property(duk_context* ctx);
...
DUK_INTERNAL_DECL duk_ret_t
duk_bi_typedarray_bytelength_getter(duk_context* ctx);
DUK_INTERNAL_DECL duk_ret_t duk_bi_buffer_slice_shared(duk_context* ctx);
DUK_INTERNAL_DECL duk_ret_t
duk_bi_typedarray_byteoffset_getter(duk_context* ctx);
...
DUK_INTERNAL_DECL duk_ret_t
duk_bi_textencoder_prototype_encoding_getter(duk_context* ctx);
DUK_INTERNAL_DECL duk_ret_t
duk_bi_textencoder_prototype_encode(duk_context* ctx);
DUK_INTERNAL_DECL duk_ret_t
duk_bi_textdecoder_prototype_shared_getter(duk_context* ctx);
DUK_INTERNAL_DECL duk_ret_t
duk_bi_textdecoder_prototype_decode(duk_context* ctx);
