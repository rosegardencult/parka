...
DUK_LOCAL_DECL duk_uint_fast32_t
duk__dec_decode_hex_escape(duk_json_dec_ctx* js_ctx, duk_small_uint_t n);
...
DUK_LOCAL_DECL void duk__emit_2(duk_json_enc_ctx* js_ctx, duk_uint_fast8_t ch1,
...
#  if defined(DUK_USE_FASTINT)
DUK_LOCAL_DECL void duk__enc_fastint_tval(duk_json_enc_ctx* js_ctx,
                                          duk_tval* tv);
#  endif
#  if defined(DUK_USE_JX) || defined(DUK_USE_JC)
DUK_LOCAL_DECL void duk__enc_buffer_jx_jc(duk_json_enc_ctx* js_ctx,
                                          duk_hbuffer* h);
DUK_LOCAL_DECL void duk__enc_pointer(duk_json_enc_ctx* js_ctx, void* ptr);
#    if defined(DUK_USE_BUFFEROBJECT_SUPPORT)
DUK_LOCAL_DECL void duk__enc_bufobj(duk_json_enc_ctx* js_ctx,
                                    duk_hbufobj* h_bufobj);
#    endif
#  endif
#  if defined(DUK_USE_JSON_STRINGIFY_FASTPATH)
DUK_LOCAL_DECL void duk__enc_buffer_json_fastpath(duk_json_enc_ctx* js_ctx,
                                                  duk_hbuffer* h);
#  endif
...
DUK_LOCAL const duk_uint8_t duk__json_quotestr_lookup[256] = {
    ...
    0xe6, 0xf2, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80,
    0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x20, 0x21, 0xa2, 0x23,
    0x24, 0x25, 0x26, 0x27, 0x28, 0x29, 0x2a, 0x2b, 0x2c, 0x2d, 0x2e, 0x2f,
    0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39, 0x3a, 0x3b,
    0x3c, 0x3d, 0x3e, 0x3f, 0x40, 0x41, 0x42, 0x43, 0x44, 0x45, 0x46, 0x47,
    0x48, 0x49, 0x4a, 0x4b, 0x4c, 0x4d, 0x4e, 0x4f, 0x50, 0x51, 0x52, 0x53,
    0x54, 0x55, 0x56, 0x57, 0x58, 0x59, 0x5a, 0x5b, 0xdc, 0x5d, 0x5e, 0x5f,
    0x60, 0x61, 0x62, 0x63, 0x64, 0x65, 0x66, 0x67, 0x68, 0x69, 0x6a, 0x6b,
    0x6c, 0x6d, 0x6e, 0x6f, 0x70, 0x71, 0x72, 0x73, 0x74, 0x75, 0x76, 0x77,
    0x78, 0x79, 0x7a, 0x7b, 0x7c, 0x7d, 0x7e, 0x81, 0x81, 0x81, 0x81, 0x81,
...
DUK_LOCAL const duk_uint8_t duk__json_quotestr_esc[14] = {
    DUK_ASC_NUL,  DUK_ASC_NUL, DUK_ASC_NUL,  DUK_ASC_NUL,  DUK_ASC_NUL,
...
DUK_LOCAL const duk_uint8_t duk__json_decstr_lookup[256] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x20, 0x21, 0x00, 0x23,
    0x24, 0x25, 0x26, 0x27, 0x28, 0x29, 0x2a, 0x2b, 0x2c, 0x2d, 0x2e, 0x2f,
    0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39, 0x3a, 0x3b,
    0x3c, 0x3d, 0x3e, 0x3f, 0x40, 0x41, 0x42, 0x43, 0x44, 0x45, 0x46, 0x47,
    0x48, 0x49, 0x4a, 0x4b, 0x4c, 0x4d, 0x4e, 0x4f, 0x50, 0x51, 0x52, 0x53,
    0x54, 0x55, 0x56, 0x57, 0x58, 0x59, 0x5a, 0x5b, 0x00, 0x5d, 0x5e, 0x5f,
    0x60, 0x61, 0x62, 0x63, 0x64, 0x65, 0x66, 0x67, 0x68, 0x69, 0x6a, 0x6b,
    0x6c, 0x6d, 0x6e, 0x6f, 0x70, 0x71, 0x72, 0x73, 0x74, 0x75, 0x76, 0x77,
...
#  if defined(DUK_USE_JSON_EATWHITE_FASTPATH)
     ...
     */
    DUK_ASSERT(duk__json_eatwhite_lookup[0x00] ==
               0x00); /* end-of-input breaks */
...
DUK_LOCAL void duk__dec_req_stridx(duk_json_dec_ctx* js_ctx,
  ...
  DUK_ASSERT(*(js_ctx->p - 1) ==
             *(p - 1)); /* first character has been matched */
...
#  if defined(DUK_USE_JSON_DECSTRING_FASTPATH)
  for (;;) {
    ...
    q = DUK_BW_ENSURE_RAW(js_ctx->thr, bw, safe + DUK_UNICODE_MAX_XUTF8_LENGTH,
                          q);
...
#  if defined(DUK_USE_JSON_DECNUMBER_FASTPATH)
     ...
     * XXX: candidate for removal.
     */
    DUK_ASSERT(duk__json_decnumber_lookup[0x00] ==
               0x00); /* end-of-input breaks */
...
#  else  /* DUK_USE_JSON_DECNUMBER_FASTPATH */
    if (!((x >= DUK_ASC_0 && x <= DUK_ASC_9) ||
          (x == DUK_ASC_PERIOD || x == DUK_ASC_LC_E || x == DUK_ASC_UC_E ||
           x == DUK_ASC_MINUS || x == DUK_ASC_PLUS))) {
...
DUK_LOCAL void duk__dec_object(duk_json_dec_ctx* js_ctx) {
  ...
  for (;;) {
    ...
    DUK_DDD(DUK_DDDPRINT("parse_object: obj=%!T, x=%ld, key_count=%ld",
                         (duk_tval*)duk_get_tval(thr, -1), (long)x,
                         (long)key_count));
...
#  if defined(DUK_USE_JX)
    if (js_ctx->flag_ext_custom && x == DUK_ASC_MINUS &&
      ...
      duk__dec_req_stridx(
          js_ctx,
          DUK_STRIDX_MINUS_INFINITY); /* "-Infinity", '-' has been eaten */
...
DUK_LOCAL void duk__dec_reviver_walk(duk_json_dec_ctx* js_ctx) {
  ...
  DUK_DDD(DUK_DDDPRINT("walk: top=%ld, holder=%!T, name=%!T",
                       (long)duk_get_top(thr), (duk_tval*)duk_get_tval(thr, -2),
                       (duk_tval*)duk_get_tval(thr, -1)));
    ...
    if (duk_js_isarray_hobject(h)) {
      ...
      for (i = 0; i < arr_len; i++) {
        ...
        DUK_DDD(DUK_DDDPRINT(
            "walk: array, top=%ld, i=%ld, arr_len=%ld, holder=%!T, name=%!T, "
            "val=%!T",
      ...
      while (duk_next(thr, -1 /*enum_index*/, 0 /*get_value*/)) {
        DUK_DDD(DUK_DDDPRINT(
            "walk: object, top=%ld, holder=%!T, name=%!T, val=%!T, enum=%!iT, "
            "obj_key=%!T",
  ...
  DUK_DDD(DUK_DDDPRINT("walk: top=%ld, result=%!T", (long)duk_get_top(thr),
                       (duk_tval*)duk_get_tval(thr, -1)));
}
...
#  define DUK__MKESC(nybbles, esc1, esc2)    \
    (((duk_uint_fast32_t)(nybbles)) << 16) | \
        (((duk_uint_fast32_t)(esc1)) << 8) | ((duk_uint_fast32_t)(esc2))
...
DUK_LOCAL void duk__enc_quote_string(duk_json_enc_ctx* js_ctx,
  ...
  DUK_DDD(
      DUK_DDDPRINT("duk__enc_quote_string: h_str=%!O", (duk_heaphdr*)h_str));
  ...
  while (p < p_end) {
    ...
    now =
        (left > DUK__JSON_ENCSTR_CHUNKSIZE ? DUK__JSON_ENCSTR_CHUNKSIZE : left);
...
#  endif /* DUK_USE_JSON_QUOTESTRING_FASTPATH */
        ...
        /* If XUTF-8 decoding fails, treat the offending byte as a codepoint
         * directly and go forward one byte.  This is of course very lossy, but
         * allows some kind of output to be produced even for internal strings
         * which don't conform to XUTF-8.  All standard ECMAScript strings are
         * always CESU-8, so this behavior does not violate the ECMAScript
         * specification.  The behavior is applied to all modes, including
         * ECMAScript standard JSON.  Because the current XUTF-8 decoding is not
         * very strict, this behavior only really affects initial bytes and
         * truncated codepoints.
         *
         * Another alternative would be to scan forwards to start of next
         * codepoint (or end of input) and emit just one replacement codepoint.
         */
...
#  if defined(DUK_USE_JX) || defined(DUK_USE_JC)
  if (!(js_ctx->flags &
        (DUK_JSON_FLAG_EXT_CUSTOM | DUK_JSON_FLAG_EXT_COMPATIBLE))) {
...
DUK_LOCAL void duk__enc_fastint_tval(duk_json_enc_ctx* js_ctx, duk_tval* tv) {
   ...
   * -9223372036854775808 (20 chars long).  Alloc space for 64-bit range to be
   * safe.
   */
...
DUK_LOCAL void duk__enc_buffer_data(duk_json_enc_ctx* js_ctx,
                                    duk_uint8_t* buf_data, duk_size_t buf_len) {
  duk_hthread* thr;
  duk_uint8_t* q;
  duk_size_t space;
  ...
  DUK_ASSERT(js_ctx->flag_ext_custom ||
             js_ctx->flag_ext_compatible); /* caller checks */
  ...
  DUK_ASSERT((space - 2) / 2 >=
             buf_len); /* overflow not possible, buffer limits */
  q = DUK_BW_ENSURE_GETPTR(thr, &js_ctx->bw, space);
...
DUK_LOCAL void duk__enc_buffer_jx_jc(duk_json_enc_ctx* js_ctx, duk_hbuffer* h) {
  duk__enc_buffer_data(
      js_ctx, (duk_uint8_t*)DUK_HBUFFER_GET_DATA_PTR(js_ctx->thr->heap, h),
      (duk_size_t)DUK_HBUFFER_GET_SIZE(h));
}
#  endif /* DUK_USE_JX || DUK_USE_JC */

#  if defined(DUK_USE_JSON_STRINGIFY_FASTPATH)
DUK_LOCAL void duk__enc_buffer_json_fastpath(duk_json_enc_ctx* js_ctx,
                                             duk_hbuffer* h) {
  duk_size_t i, n;
  ...
  if (DUK_UNLIKELY(js_ctx->h_gap != NULL)) {
    for (i = 0; i < n; i++) {
      ...
      q += DUK_SPRINTF((char*)q, "\"%lu\": %u,", (unsigned long)i,
                       (unsigned int)buf[i]);
...
#  if defined(DUK_USE_BUFFEROBJECT_SUPPORT)
#    if defined(DUK_USE_JX) || defined(DUK_USE_JC)
DUK_LOCAL void duk__enc_bufobj(duk_json_enc_ctx* js_ctx,
                               duk_hbufobj* h_bufobj) {
...
DUK_LOCAL void duk__enc_newline_indent(duk_json_enc_ctx* js_ctx,
  ...
  DUK_ASSERT(DUK_HSTRING_GET_BYTELEN(js_ctx->h_gap) >
             0); /* caller guarantees */
...
DUK_LOCAL void duk__enc_objarr_exit(duk_json_enc_ctx* js_ctx,
  ...
  h_target = duk_known_hobject(
      thr, *entry_top - 1); /* original target at entry_top - 1 */
...
DUK_LOCAL void duk__enc_object(duk_json_enc_ctx* js_ctx) {
  ...
  DUK_DDD(DUK_DDDPRINT("duk__enc_object: obj=%!T",
                       (duk_tval*)duk_get_tval(thr, -1)));
  ...
  if (js_ctx->idx_proplist >= 0) {
    ...
    (void)duk_hobject_get_enumerated_keys(
        thr, DUK_ENUM_OWN_PROPERTIES_ONLY /*flags*/); /* [ ... target ] -> [ ...
                                                         target keys ] */
    idx_keys = duk_require_normalize_index(thr, -1);
    /* leave stack unbalanced on purpose */
  }

  DUK_DDD(DUK_DDDPRINT("idx_keys=%ld, h_keys=%!T", (long)idx_keys,
                       (duk_tval*)duk_get_tval(thr, idx_keys)));
  ...
  for (i = 0; i < arr_len; i++) {
    ...
    DUK_ASSERT(
        !DUK_HSTRING_HAS_SYMBOL(h_key)); /* proplist filtering; enum options */
  ...
  if (emitted) {
    DUK_ASSERT(*((duk_uint8_t*)DUK_BW_GET_PTR(js_ctx->thr, &js_ctx->bw) - 1) ==
               DUK_ASC_COMMA);
    DUK__UNEMIT_1(js_ctx); /* eat trailing comma */
    if (DUK_UNLIKELY(js_ctx->h_gap != NULL)) {
...
DUK_LOCAL void duk__enc_array(duk_json_enc_ctx* js_ctx) {
  ...
  for (i = 0; i < arr_len; i++) {
    DUK_DDD(DUK_DDDPRINT("array entry loop: array=%!T, index=%ld, arr_len=%ld",
                         (duk_tval*)duk_get_tval(thr, idx_arr), (long)i,
                         (long)arr_len));
...
DUK_LOCAL duk_bool_t duk__enc_value(duk_json_enc_ctx* js_ctx,
  ...
  DUK_ASSERT(!DUK_HSTRING_HAS_SYMBOL(
      DUK_TVAL_GET_STRING(tv_key))); /* Caller responsible. */
...
#  endif
      case DUK_HOBJECT_CLASS_BOOLEAN: {
        DUK_DDD(DUK_DDDPRINT(
            "value is a Boolean/Buffer/Pointer object -> get internal value"));
...
#  endif
    ...
    case DUK_TAG_BOOLEAN: {
      DUK__EMIT_STRIDX(js_ctx, DUK_TVAL_GET_BOOLEAN(tv) ? DUK_STRIDX_TRUE
                                                        : DUK_STRIDX_FALSE);
      break;
    }
#  if defined(DUK_USE_JX) || defined(DUK_USE_JC)
...
#    endif
    ...
    case DUK_TAG_OBJECT: {
      ...
      duk_uint32_t c_bit, c_all, c_array, c_unbox, c_undef, c_func, c_bufobj,
          c_object, c_abort;
      ...
      if (duk_hobject_hasprop_raw(js_ctx->thr, obj,
        ...
        DUK_DD(
            DUK_DDPRINT("object has a .toJSON property or object is a Proxy, "
                        "abort fast path"));
        goto abort_fastpath;
      }
...
#    if defined(DUK_USE_JX) || defined(DUK_USE_JC)
      if (js_ctx->flag_ext_custom_or_compatible) {
        ...
        c_abort = 0;
        c_object = c_all &
                   ~(c_array | c_unbox | c_func | c_bufobj | c_undef | c_abort);
      } else
#    endif
      {
        c_all = DUK_HOBJECT_CMASK_ALL;
      ...
      if (c_bit & c_object) {
        ...
        if (DUK_HOBJECT_HAS_ARRAY_PART(obj)) {
          DUK_DD(
              DUK_DDPRINT("non-Array object has array part, abort fast path"));
          goto abort_fastpath;
        }
        ...
        for (i = 0; i < (duk_uint_fast32_t)DUK_HOBJECT_GET_ENEXT(obj); i++) {
          ...
          if (DUK_HSTRING_HAS_ARRIDX(k)) {
             ...
             */
            DUK_DD(
                DUK_DDPRINT("property key is an array index, abort fast path"));
            goto abort_fastpath;
          }
          ...
          if (duk__json_stringify_fast_value(js_ctx, tv_val) == 0) {
            DUK_DD(
                DUK_DDPRINT("prop value not supported, rewind key and colon"));
            DUK_BW_SET_SIZE(js_ctx->thr, &js_ctx->bw, prev_size);
          } else {
            DUK__EMIT_1(js_ctx, DUK_ASC_COMMA);
            emitted = 1;
        ...
        if (emitted) {
          DUK_ASSERT(*((duk_uint8_t*)DUK_BW_GET_PTR(js_ctx->thr, &js_ctx->bw) -
                       1) == DUK_ASC_COMMA);
          DUK__UNEMIT_1(js_ctx); /* eat trailing comma */
          if (DUK_UNLIKELY(js_ctx->h_gap != NULL)) {
            DUK_ASSERT(js_ctx->recursion_depth >= 1);
        ...
        for (i = 0; i < arr_len; i++) {
          ...
          if (has_inherited) {
            DUK_D(
                DUK_DPRINT("gap in array, conflicting inherited property, "
                           "abort fast path"));
            goto abort_fastpath;
          }
           ...
           */
          DUK_D(
              DUK_DPRINT("gap in array, no conflicting inherited property, "
                         "remain on fast path"));
#    if defined(DUK_USE_JX)
          DUK__EMIT_STRIDX(js_ctx, js_ctx->stridx_custom_undefined);
#    else
...
#    endif
         ...
         */
        DUK_ASSERT((c_bit & DUK_HOBJECT_CMASK_SYMBOL) ==
                   0); /* Symbols are not unboxed. */
...
#    else  /* disabled */
        ...
        DUK_ASSERT(js_ctx->recursion_depth > 0);
        js_ctx
            ->recursion_depth--; /* required to keep recursion depth correct */
        goto restart_match;
#    endif /* disabled */
#    if defined(DUK_USE_JX) || defined(DUK_USE_JC)
...
#    if defined(DUK_USE_BUFFEROBJECT_SUPPORT)
      if (duk_hobject_hasprop_raw(
              js_ctx->thr, js_ctx->thr->builtins[DUK_BIDX_UINT8ARRAY_PROTOTYPE],
              DUK_HTHREAD_STRING_TO_JSON(js_ctx->thr))) {
        DUK_DD(
            DUK_DDPRINT("value is a plain buffer and there's an inherited "
                        ".toJSON, abort fast path"));
        goto abort_fastpath;
      }
#    endif
...
DUK_LOCAL duk_ret_t duk__json_stringify_fast(duk_hthread* thr, void* udata) {
  ...
  if (duk__json_stringify_fast_value(js_ctx, tv) == 0) {
    ...
    DUK_DCERROR_TYPE_INVALID_ARGS(
        thr); /* Error message is ignored, so doesn't matter. */
  }
...
DUK_INTERNAL
void duk_bi_json_parse_helper(duk_hthread* thr, duk_idx_t idx_value,
                              duk_idx_t idx_reviver, duk_small_uint_t flags) {
...
#  endif
  ...
  DUK_DDD(DUK_DDDPRINT(
      ...
      (duk_tval*)duk_get_tval(thr, idx_reviver), (unsigned long)flags,
      (long)duk_get_top(thr)));
...
#  if defined(DUK_USE_JX) || defined(DUK_USE_JC)
  js_ctx->flag_ext_custom_or_compatible =
      flags & (DUK_JSON_FLAG_EXT_CUSTOM | DUK_JSON_FLAG_EXT_COMPATIBLE);
#  endif

  h_text =
      duk_to_hstring(thr, idx_value); /* coerce in-place; rejects Symbols */
  ...
  if (duk_is_callable(thr, idx_reviver)) {
    ...
    duk_put_prop_stridx_short(thr, -2,
                              DUK_STRIDX_EMPTY_STRING); /* default attrs ok */
    duk_push_hstring_stridx(
        thr, DUK_STRIDX_EMPTY_STRING); /* -> [ ... val root "" ] */
  ...
  DUK_DDD(DUK_DDDPRINT(
      "JSON parse end: text=%!T, reviver=%!T, flags=0x%08lx, result=%!T, "
      "stack_top=%ld",
      (duk_tval*)duk_get_tval(thr, idx_value),
      (duk_tval*)duk_get_tval(thr, idx_reviver), (unsigned long)flags,
      (duk_tval*)duk_get_tval(thr, -1), (long)duk_get_top(thr)));

  DUK_ASSERT(duk_get_top(thr) == entry_top + 1);
}

DUK_INTERNAL
void duk_bi_json_stringify_helper(duk_hthread* thr, duk_idx_t idx_value,
                                  duk_idx_t idx_replacer, duk_idx_t idx_space,
  ...
  DUK_DDD(
      DUK_DDDPRINT("JSON stringify start: value=%!T, replacer=%!T, space=%!T, "
                   "flags=0x%08lx, stack_top=%ld",
                   (duk_tval*)duk_get_tval(thr, idx_value),
                   (duk_tval*)duk_get_tval(thr, idx_replacer),
                   (duk_tval*)duk_get_tval(thr, idx_space),
                   (unsigned long)flags, (long)duk_get_top(thr)));
...
#  if defined(DUK_USE_JX) || defined(DUK_USE_JC)
  js_ctx->stridx_custom_undefined =
      DUK_STRIDX_LC_NULL; /* standard JSON; array gaps */
#    if defined(DUK_USE_JX)
  if (flags & DUK_JSON_FLAG_EXT_CUSTOM) {
    ...
    js_ctx->stridx_custom_function = (flags & DUK_JSON_FLAG_AVOID_KEY_QUOTES)
...
#  endif /* DUK_USE_JX || DUK_USE_JC */
    ...
    if (DUK_HOBJECT_IS_CALLABLE(h)) {
      ...
      while (duk_next(thr, -1 /*enum_index*/, 1 /*get_value*/)) {
        ...
        if (duk__enc_allow_into_proplist(duk_get_tval(thr, -1))) {
          ...
          duk_put_prop_index(thr, -4,
                             plist_idx); /* -> [ ... proplist enum_obj key ] */
          plist_idx++;
          duk_pop(thr);
        } else {
  ...
  if (duk_is_number(thr, idx_space)) {
     ...
     */
    static const char spaces[10] = {DUK_ASC_SPACE, DUK_ASC_SPACE, DUK_ASC_SPACE,
                                    DUK_ASC_SPACE, DUK_ASC_SPACE, DUK_ASC_SPACE,
                                    DUK_ASC_SPACE, DUK_ASC_SPACE, DUK_ASC_SPACE,
                                    DUK_ASC_SPACE}; /* XXX: helper */

    /* ToInteger() coercion; NaN -> 0, infinities are clamped to 0 and 10 */
    nspace = (duk_small_int_t)duk_to_int_clamped(thr, idx_space, 0 /*minval*/,
                                                 10 /*maxval*/);
...
#  if defined(DUK_USE_JSON_STRINGIFY_FASTPATH)
  if (js_ctx->h_replacer == NULL && /* replacer is a mutation risk */
    ...
    thr->heap->ms_base_flags |=
        DUK_MS_FLAG_NO_OBJECT_COMPACTION; /* Avoid attempt to compact any
                                             objects. */
    thr->heap->pf_prevent_count++;        /* Prevent finalizers. */
    DUK_ASSERT(thr->heap->pf_prevent_count != 0); /* Wrap. */

    pcall_rc = duk_safe_call(thr, duk__json_stringify_fast,
                             (void*)js_ctx /*udata*/, 1 /*nargs*/, 0 /*nret*/);
...
#  endif
  ...
  DUK_DDD(DUK_DDDPRINT(
      "before: flags=0x%08lx, loop=%!T, replacer=%!O, "
      "proplist=%!T, gap=%!O, holder=%!T",
      (unsigned long)js_ctx->flags,
      (duk_tval*)duk_get_tval(thr, js_ctx->idx_loop),
      (duk_heaphdr*)js_ctx->h_replacer,
      (duk_tval*)(js_ctx->idx_proplist >= 0
                      ? duk_get_tval(thr, js_ctx->idx_proplist)
                      : NULL),
      (duk_heaphdr*)js_ctx->h_gap, (duk_tval*)duk_get_tval(thr, -1)));
  ...
  if (DUK_UNLIKELY(duk__enc_value(js_ctx, idx_holder) ==
                   0)) { /* [ ... holder key ] -> [ ... holder ] */
    /* Result is undefined. */
    duk_push_undefined(thr);
  } else {
  ...
  DUK_DDD(DUK_DDDPRINT(
      "after: flags=0x%08lx, loop=%!T, replacer=%!O, "
      "proplist=%!T, gap=%!O, holder=%!T",
      (unsigned long)js_ctx->flags,
      (duk_tval*)duk_get_tval(thr, js_ctx->idx_loop),
      (duk_heaphdr*)js_ctx->h_replacer,
      (duk_tval*)(js_ctx->idx_proplist >= 0
                      ? duk_get_tval(thr, js_ctx->idx_proplist)
                      : NULL),
      (duk_heaphdr*)js_ctx->h_gap, (duk_tval*)duk_get_tval(thr, idx_holder)));
...
#  endif
  ...
  DUK_DDD(DUK_DDDPRINT(
      "JSON stringify end: value=%!T, replacer=%!T, space=%!T, "
      "flags=0x%08lx, result=%!T, stack_top=%ld",
      (duk_tval*)duk_get_tval(thr, idx_value),
      (duk_tval*)duk_get_tval(thr, idx_replacer),
      (duk_tval*)duk_get_tval(thr, idx_space), (unsigned long)flags,
      (duk_tval*)duk_get_tval(thr, -1), (long)duk_get_top(thr)));
...
DUK_INTERNAL duk_ret_t duk_bi_json_object_parse(duk_hthread* thr) {
  duk_bi_json_parse_helper(thr, 0 /*idx_value*/, 1 /*idx_replacer*/,
                           0 /*flags*/);
  return 1;
}

DUK_INTERNAL duk_ret_t duk_bi_json_object_stringify(duk_hthread* thr) {
  duk_bi_json_stringify_helper(thr, 0 /*idx_value*/, 1 /*idx_replacer*/,
                               2 /*idx_space*/, 0 /*flags*/);
  return 1;
}
