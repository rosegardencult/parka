...
#  if defined(DUK_USE_DOUBLE_ME)
  return (du.ull[DUK_DBL_IDX_ULL0] & DUK_U64_CONSTANT(0x000000007ff00000)) ==
         DUK_U64_CONSTANT(0x000000007ff00000);
#  else
  return (du.ull[DUK_DBL_IDX_ULL0] & DUK_U64_CONSTANT(0x7ff0000000000000)) ==
...
DUK_INTERNAL duk_bool_t duk_double_same_sign(duk_double_t x, duk_double_t y) {
  ...
  return (((du1.ui[DUK_DBL_IDX_UI0] ^ du2.ui[DUK_DBL_IDX_UI0]) &
           0x80000000UL) == 0);
}
