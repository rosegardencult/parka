...
DUK_EXTERNAL void* duk_resize_buffer(duk_hthread* thr, duk_idx_t idx,
                                     duk_size_t new_size) {
...
DUK_EXTERNAL void* duk_steal_buffer(duk_hthread* thr, duk_idx_t idx,
                                    duk_size_t* out_size) {
  duk_hbuffer_dynamic* h;
  void* ptr;
  duk_size_t sz;
...
DUK_EXTERNAL void duk_config_buffer(duk_hthread* thr, duk_idx_t idx, void* ptr,
                                    duk_size_t len) {
