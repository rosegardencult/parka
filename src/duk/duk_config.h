...
#    if !defined(DUK_USE_BYTEORDER) && \
        (defined(DUK_F_M68K) || defined(DUK_F_PPC))
#      define DUK_USE_BYTEORDER 3
#    endif
...
#    if defined(DUK_USE_DATE_NOW_WINDOWS_SUBMS) || \
        defined(DUK_USE_DATE_NOW_WINDOWS)
...
#        define DUK_BSWAP64(x) \
          ((duk_uint64_t)__builtin_bswap64((duk_uint64_t)(x)))
#      endif
#      if __has_builtin(__builtin_bswap32)
#        define DUK_BSWAP32(x) \
          ((duk_uint32_t)__builtin_bswap32((duk_uint32_t)(x)))
#      endif
#      if __has_builtin(__builtin_bswap16)
#        define DUK_BSWAP16(x) \
          ((duk_uint16_t)__builtin_bswap16((duk_uint16_t)(x)))
#      endif
#    endif
...
#    elif !defined(DUK_F_VBCC) && !defined(DUK_F_MSVC) &&     \
        !defined(DUK_F_BCC) && !defined(DUK_F_OLD_SOLARIS) && \
        !defined(DUK_F_AIX)
