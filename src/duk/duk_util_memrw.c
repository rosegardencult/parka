...
DUK_INTERNAL DUK_ALWAYS_INLINE duk_uint16_t
duk_raw_read_u16_be(const duk_uint8_t* p) {
  duk__u16_union u;
...
DUK_INTERNAL DUK_ALWAYS_INLINE duk_uint32_t
duk_raw_read_u32_be(const duk_uint8_t* p) {
  duk__u32_union u;
...
DUK_INTERNAL DUK_ALWAYS_INLINE duk_float_t
duk_raw_read_float_be(const duk_uint8_t* p) {
  duk_float_union fu;
...
DUK_INTERNAL DUK_ALWAYS_INLINE duk_double_t
duk_raw_read_double_be(const duk_uint8_t* p) {
  duk_double_union du;
...
DUK_INTERNAL DUK_ALWAYS_INLINE duk_uint16_t
duk_raw_readinc_u16_be(const duk_uint8_t** p) {
...
DUK_INTERNAL DUK_ALWAYS_INLINE duk_uint32_t
duk_raw_readinc_u32_be(const duk_uint8_t** p) {
...
DUK_INTERNAL DUK_ALWAYS_INLINE duk_float_t
duk_raw_readinc_float_be(const duk_uint8_t** p) {
...
DUK_INTERNAL DUK_ALWAYS_INLINE duk_double_t
duk_raw_readinc_double_be(const duk_uint8_t** p) {
...
DUK_INTERNAL DUK_ALWAYS_INLINE void duk_raw_writeinc_double_be(
    duk_uint8_t** p, duk_double_t val) {
