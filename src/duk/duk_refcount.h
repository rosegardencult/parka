...
#    define DUK_TVAL_INCREF_FAST(thr, tv)                      \
      do {                                                     \
        ...
        if (DUK_TVAL_NEEDS_REFCOUNT_UPDATE(duk__tv)) {         \
          ...
          DUK_ASSERT(DUK_HEAPHDR_GET_REFCOUNT(duk__h) !=       \
                     0); /* No wrapping. */                    \
        }                                                      \
      } while (0)
...
#    define DUK_HEAPHDR_DECREF_NORZ_FAST(thr, h)                        \
      DUK_HEAPHDR_DECREF_FAST_RAW((thr), (h), duk_heaphdr_refzero_norz, \
                                  duk_heaphdr*)
...
#      define DUK_HEAPHDR_DECREF(thr, h)                             \
        DUK_HEAPHDR_DECREF_FAST_RAW((thr), (h), duk_heaphdr_refzero, \
                                    duk_heaphdr*)
...
#      define DUK_HSTRING_DECREF(thr, h)                             \
        DUK_HEAPHDR_DECREF_FAST_RAW((thr), (h), duk_hstring_refzero, \
                                    duk_hstring*)
#      define DUK_HSTRING_DECREF_NORZ(thr, h)                        \
        DUK_HEAPHDR_DECREF_FAST_RAW((thr), (h), duk_hstring_refzero, \
                                    duk_hstring*) /* no 'norz' variant */
#      define DUK_HOBJECT_INCREF(thr, h) \
        DUK_HEAPHDR_INCREF((thr), (duk_heaphdr*)(h))
#      define DUK_HOBJECT_DECREF(thr, h)                             \
        DUK_HEAPHDR_DECREF_FAST_RAW((thr), (h), duk_hobject_refzero, \
                                    duk_hobject*)
#      define DUK_HOBJECT_DECREF_NORZ(thr, h)                             \
        DUK_HEAPHDR_DECREF_FAST_RAW((thr), (h), duk_hobject_refzero_norz, \
                                    duk_hobject*)
#      define DUK_HBUFFER_INCREF(thr, h) \
        DUK_HEAPHDR_INCREF((thr), (duk_heaphdr*)(h))
#      define DUK_HBUFFER_DECREF(thr, h)                             \
        DUK_HEAPHDR_DECREF_FAST_RAW((thr), (h), duk_hbuffer_refzero, \
                                    duk_hbuffer*)
#      define DUK_HBUFFER_DECREF_NORZ(thr, h)                        \
        DUK_HEAPHDR_DECREF_FAST_RAW((thr), (h), duk_hbuffer_refzero, \
                                    duk_hbuffer*) /* no 'norz' variant */
...
#      define DUK_TVAL_DECREF_NORZ(thr, tv) \
        DUK_TVAL_DECREF_NORZ_SLOW((thr), (tv))
...
#      define DUK_HEAPHDR_DECREF_NORZ(thr, h) \
        DUK_HEAPHDR_DECREF_NORZ_SLOW((thr), (h))
#      define DUK_HSTRING_INCREF(thr, h) \
        DUK_HEAPHDR_INCREF((thr), (duk_heaphdr*)(h))
#      define DUK_HSTRING_DECREF(thr, h) DUK_HSTRING_DECREF_SLOW((thr), (h))
#      define DUK_HSTRING_DECREF_NORZ(thr, h) \
        DUK_HSTRING_DECREF_NORZ_SLOW((thr), (h))
#      define DUK_HOBJECT_INCREF(thr, h) \
        DUK_HEAPHDR_INCREF((thr), (duk_heaphdr*)(h))
#      define DUK_HOBJECT_DECREF(thr, h) DUK_HOBJECT_DECREF_SLOW((thr), (h))
#      define DUK_HOBJECT_DECREF_NORZ(thr, h) \
        DUK_HOBJECT_DECREF_NORZ_SLOW((thr), (h))
#      define DUK_HBUFFER_INCREF(thr, h) \
        DUK_HEAPHDR_INCREF((thr), (duk_heaphdr*)(h))
#      define DUK_HBUFFER_DECREF(thr, h) DUK_HBUFFER_DECREF_SLOW((thr), (h))
#      define DUK_HBUFFER_DECREF_NORZ(thr, h) \
        DUK_HBUFFER_DECREF_NORZ_SLOW((thr), (h))
#      define DUK_HCOMPFUNC_INCREF(thr, h) \
        DUK_HEAPHDR_INCREF((thr), (duk_heaphdr*)&(h)->obj)
#      define DUK_HCOMPFUNC_DECREF(thr, h) \
        DUK_HOBJECT_DECREF_SLOW((thr), (duk_hobject*)&(h)->obj)
#      define DUK_HCOMPFUNC_DECREF_NORZ(thr, h) \
        DUK_HOBJECT_DECREF_NORZ_SLOW((thr), (duk_hobject*)&(h)->obj)
#      define DUK_HNATFUNC_INCREF(thr, h) \
        DUK_HEAPHDR_INCREF((thr), (duk_heaphdr*)&(h)->obj)
#      define DUK_HNATFUNC_DECREF(thr, h) \
        DUK_HOBJECT_DECREF_SLOW((thr), (duk_hobject*)&(h)->obj)
...
#      define DUK_HBUFOBJ_DECREF(thr, h) \
        DUK_HOBJECT_DECREF_SLOW((thr), (duk_hobject*)&(h)->obj)
#      define DUK_HBUFOB_DECREF_NORZ(thr, h) \
        DUK_HOBJECT_DECREF_NORZ_SLOW((thr), (duk_hobject*)&(h)->obj)
#      define DUK_HTHREAD_INCREF(thr, h) \
        DUK_HEAPHDR_INCREF((thr), (duk_heaphdr*)&(h)->obj)
#      define DUK_HTHREAD_DECREF(thr, h) \
...
#    define DUK_TVAL_SET_LIGHTFUNC_UPDREF_ALT0(thr, tvptr_dst, lf_v, lf_fp, \
                                               lf_flags)                    \
      do {                                                                  \
        duk_tval* tv__dst;                                                  \
        duk_tval tv__tmp;                                                   \
...
#    else
#      define DUK_TVAL_SET_I48_UPDREF \
        DUK_TVAL_SET_DOUBLE_CAST_UPDREF /* XXX: fast int-to-double */
...
#    define DUK_TVAL_SET_FASTINT_UPDREF \
      DUK_TVAL_SET_I48_UPDREF /* convenience */
...
DUK_INTERNAL_DECL void duk_hobject_refcount_finalize_norz(duk_heap* heap,
                                                          duk_hobject* h);
#    if 0 /* Not needed: fast path handles inline; slow path uses \
             duk_heaphdr_decref() which is needed anyway. */
...
DUK_INTERNAL_DECL void duk_heaphdr_refzero_norz(duk_hthread* thr,
                                                duk_heaphdr* h);
#    if defined(DUK_USE_FAST_REFCOUNT_DEFAULT)
DUK_INTERNAL_DECL void duk_hstring_refzero(
    duk_hthread* thr, duk_hstring* h); /* no 'norz' variant */
DUK_INTERNAL_DECL void duk_hbuffer_refzero(
    duk_hthread* thr, duk_hbuffer* h); /* no 'norz' variant */
DUK_INTERNAL_DECL void duk_hobject_refzero(duk_hthread* thr, duk_hobject* h);
DUK_INTERNAL_DECL void duk_hobject_refzero_norz(duk_hthread* thr,
                                                duk_hobject* h);
#    else
...
DUK_INTERNAL_DECL void duk_heaphdr_decref_norz(duk_hthread* thr,
                                               duk_heaphdr* h);
#    endif
#  else  /* DUK_USE_REFERENCE_COUNTING */
/* no refcounting */
