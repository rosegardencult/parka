...
#  define DUK_HOBJECT_FLAG_CALLABLE \
    DUK_HEAPHDR_USER_FLAG(2) /* object is callable */
#  define DUK_HOBJECT_FLAG_BOUNDFUNC \
    DUK_HEAPHDR_USER_FLAG(           \
        3) /* object established using Function.prototype.bind() */
#  define DUK_HOBJECT_FLAG_COMPFUNC                                           \
    DUK_HEAPHDR_USER_FLAG(4) /* object is a compiled function (duk_hcompfunc) \
                              */
#  define DUK_HOBJECT_FLAG_NATFUNC \
    DUK_HEAPHDR_USER_FLAG(5) /* object is a native function (duk_hnatfunc) */
#  define DUK_HOBJECT_FLAG_BUFOBJ \
    DUK_HEAPHDR_USER_FLAG(        \
        6) /* object is a buffer object (duk_hbufobj) (always exotic) */
#  define DUK_HOBJECT_FLAG_FASTREFS                                         \
    DUK_HEAPHDR_USER_FLAG(7) /* object has no fields needing DECREF/marking \
                                beyond base duk_hobject header */
...
#  define DUK_HOBJECT_FLAG_NAMEBINDING                                    \
    DUK_HEAPHDR_USER_FLAG(                                                \
        12) /* function: create binding for func name (function templates \
               only, used for named function expressions) */
...
#  define DUK_HOBJECT_FLAG_HAVE_FINALIZER \
    DUK_HEAPHDR_USER_FLAG(                \
        14) /* object has a callable (own) finalizer property */
...
#  define DUK_HOBJECT_FLAG_EXOTIC_PROXYOBJ \
    DUK_HEAPHDR_USER_FLAG(18) /* 'Proxy' object */
#  define DUK_HOBJECT_FLAG_SPECIAL_CALL \
    DUK_HEAPHDR_USER_FLAG(              \
        19) /* special casing in call behavior, for .call(), .apply(), etc. */
...
#  define DUK_HOBJECT_CLASS_THREAD \
    18 /* custom; implies DUK_HOBJECT_IS_THREAD */
...
#  define DUK_HOBJECT_CMASK_ALL_BUFOBJS                                   \
    (DUK_HOBJECT_CMASK_ARRAYBUFFER | DUK_HOBJECT_CMASK_DATAVIEW |         \
     DUK_HOBJECT_CMASK_INT8ARRAY | DUK_HOBJECT_CMASK_UINT8ARRAY |         \
     DUK_HOBJECT_CMASK_UINT8CLAMPEDARRAY | DUK_HOBJECT_CMASK_INT16ARRAY | \
     DUK_HOBJECT_CMASK_UINT16ARRAY | DUK_HOBJECT_CMASK_INT32ARRAY |       \
     DUK_HOBJECT_CMASK_UINT32ARRAY | DUK_HOBJECT_CMASK_FLOAT32ARRAY |     \
...
#  define DUK_HOBJECT_IS_ARRAY(h)                                             \
    DUK_HOBJECT_HAS_EXOTIC_ARRAY((h)) /* Rely on class Array <=> exotic Array \
                                       */
#  define DUK_HOBJECT_IS_BOUNDFUNC(h) \
    DUK_HEAPHDR_CHECK_FLAG_BITS(&(h)->hdr, DUK_HOBJECT_FLAG_BOUNDFUNC)
#  define DUK_HOBJECT_IS_COMPFUNC(h) \
    DUK_HEAPHDR_CHECK_FLAG_BITS(&(h)->hdr, DUK_HOBJECT_FLAG_COMPFUNC)
#  define DUK_HOBJECT_IS_NATFUNC(h) \
    DUK_HEAPHDR_CHECK_FLAG_BITS(&(h)->hdr, DUK_HOBJECT_FLAG_NATFUNC)
#  if defined(DUK_USE_BUFFEROBJECT_SUPPORT)
#    define DUK_HOBJECT_IS_BUFOBJ(h) \
      DUK_HEAPHDR_CHECK_FLAG_BITS(&(h)->hdr, DUK_HOBJECT_FLAG_BUFOBJ)
#  else
#    define DUK_HOBJECT_IS_BUFOBJ(h) 0
#  endif
#  define DUK_HOBJECT_IS_THREAD(h) \
    (DUK_HOBJECT_GET_CLASS_NUMBER((h)) == DUK_HOBJECT_CLASS_THREAD)
...
#  define DUK_HOBJECT_IS_NONBOUND_FUNCTION(h) \
    DUK_HEAPHDR_CHECK_FLAG_BITS(              \
        &(h)->hdr, DUK_HOBJECT_FLAG_COMPFUNC | DUK_HOBJECT_FLAG_NATFUNC)
...
#  define DUK_HOBJECT_EXOTIC_BEHAVIOR_FLAGS                              \
    (DUK_HOBJECT_FLAG_EXOTIC_ARRAY | DUK_HOBJECT_FLAG_EXOTIC_ARGUMENTS | \
     DUK_HOBJECT_FLAG_EXOTIC_STRINGOBJ | DUK_HOBJECT_FLAG_BUFOBJ |       \
...
#  define DUK_HOBJECT_VIRTUAL_PROPERTY_FLAGS                             \
    (DUK_HOBJECT_FLAG_EXOTIC_ARRAY | DUK_HOBJECT_FLAG_EXOTIC_STRINGOBJ | \
     DUK_HOBJECT_FLAG_BUFOBJ)
#  define DUK_HOBJECT_HAS_VIRTUAL_PROPERTIES(h) \
    DUK_HEAPHDR_CHECK_FLAG_BITS(&(h)->hdr, DUK_HOBJECT_VIRTUAL_PROPERTY_FLAGS)
...
#  define DUK_HOBJECT_HAS_CALLABLE(h) \
    DUK_HEAPHDR_CHECK_FLAG_BITS(&(h)->hdr, DUK_HOBJECT_FLAG_CALLABLE)
...
#  define DUK_HOBJECT_HAS_FASTREFS(h) \
    DUK_HEAPHDR_CHECK_FLAG_BITS(&(h)->hdr, DUK_HOBJECT_FLAG_FASTREFS)
...
#  define DUK_HOBJECT_HAS_HAVE_FINALIZER(h) \
    DUK_HEAPHDR_CHECK_FLAG_BITS(&(h)->hdr, DUK_HOBJECT_FLAG_HAVE_FINALIZER)
...
#  define DUK_HOBJECT_HAS_SPECIAL_CALL(h) \
    DUK_HEAPHDR_CHECK_FLAG_BITS(&(h)->hdr, DUK_HOBJECT_FLAG_SPECIAL_CALL)
...
#  define DUK_HOBJECT_SET_CALLABLE(h) \
    DUK_HEAPHDR_SET_FLAG_BITS(&(h)->hdr, DUK_HOBJECT_FLAG_CALLABLE)
#  define DUK_HOBJECT_SET_BOUNDFUNC(h) \
    DUK_HEAPHDR_SET_FLAG_BITS(&(h)->hdr, DUK_HOBJECT_FLAG_BOUNDFUNC)
#  define DUK_HOBJECT_SET_COMPFUNC(h) \
    DUK_HEAPHDR_SET_FLAG_BITS(&(h)->hdr, DUK_HOBJECT_FLAG_COMPFUNC)
#  define DUK_HOBJECT_SET_NATFUNC(h) \
    DUK_HEAPHDR_SET_FLAG_BITS(&(h)->hdr, DUK_HOBJECT_FLAG_NATFUNC)
#  if defined(DUK_USE_BUFFEROBJECT_SUPPORT)
#    define DUK_HOBJECT_SET_BUFOBJ(h) \
      DUK_HEAPHDR_SET_FLAG_BITS(&(h)->hdr, DUK_HOBJECT_FLAG_BUFOBJ)
#  endif
#  define DUK_HOBJECT_SET_FASTREFS(h) \
    DUK_HEAPHDR_SET_FLAG_BITS(&(h)->hdr, DUK_HOBJECT_FLAG_FASTREFS)
...
#  define DUK_HOBJECT_SET_HAVE_FINALIZER(h) \
    DUK_HEAPHDR_SET_FLAG_BITS(&(h)->hdr, DUK_HOBJECT_FLAG_HAVE_FINALIZER)
...
#  define DUK_HOBJECT_SET_SPECIAL_CALL(h) \
    DUK_HEAPHDR_SET_FLAG_BITS(&(h)->hdr, DUK_HOBJECT_FLAG_SPECIAL_CALL)
...
#  define DUK_HOBJECT_CLEAR_CALLABLE(h) \
    DUK_HEAPHDR_CLEAR_FLAG_BITS(&(h)->hdr, DUK_HOBJECT_FLAG_CALLABLE)
#  define DUK_HOBJECT_CLEAR_BOUNDFUNC(h) \
    DUK_HEAPHDR_CLEAR_FLAG_BITS(&(h)->hdr, DUK_HOBJECT_FLAG_BOUNDFUNC)
#  define DUK_HOBJECT_CLEAR_COMPFUNC(h) \
    DUK_HEAPHDR_CLEAR_FLAG_BITS(&(h)->hdr, DUK_HOBJECT_FLAG_COMPFUNC)
#  define DUK_HOBJECT_CLEAR_NATFUNC(h) \
    DUK_HEAPHDR_CLEAR_FLAG_BITS(&(h)->hdr, DUK_HOBJECT_FLAG_NATFUNC)
#  if defined(DUK_USE_BUFFEROBJECT_SUPPORT)
#    define DUK_HOBJECT_CLEAR_BUFOBJ(h) \
      DUK_HEAPHDR_CLEAR_FLAG_BITS(&(h)->hdr, DUK_HOBJECT_FLAG_BUFOBJ)
#  endif
#  define DUK_HOBJECT_CLEAR_FASTREFS(h) \
    DUK_HEAPHDR_CLEAR_FLAG_BITS(&(h)->hdr, DUK_HOBJECT_FLAG_FASTREFS)
...
#  define DUK_HOBJECT_CLEAR_HAVE_FINALIZER(h) \
    DUK_HEAPHDR_CLEAR_FLAG_BITS(&(h)->hdr, DUK_HOBJECT_FLAG_HAVE_FINALIZER)
...
#  endif
#  define DUK_HOBJECT_CLEAR_SPECIAL_CALL(h) \
    DUK_HEAPHDR_CLEAR_FLAG_BITS(&(h)->hdr, DUK_HOBJECT_FLAG_SPECIAL_CALL)
...
#  define DUK_HOBJECT_PROHIBITS_FASTREFS(h)                        \
    (DUK_HOBJECT_IS_COMPFUNC((h)) || DUK_HOBJECT_IS_DECENV((h)) || \
     DUK_HOBJECT_IS_OBJENV((h)) || DUK_HOBJECT_IS_BUFOBJ((h)) ||   \
     DUK_HOBJECT_IS_THREAD((h)) || DUK_HOBJECT_IS_PROXY((h)) ||    \
...
#  define DUK_PROPDESC_FLAG_NO_OVERWRITE \
    (1U << 4) /* internal define property: skip write silently if exists */
...
#  define DUK_GETDESC_FLAG_IGNORE_PROTOLOOP \
    (1U << 1) /* don't throw for prototype loop */
...
#    define DUK_HOBJECT_P_COMPUTE_SIZE(n_ent, n_arr, n_hash)     \
      ((n_ent) * (sizeof(duk_hstring*) + sizeof(duk_propvalue) + \
                  sizeof(duk_uint8_t)) +                         \
...
#    define DUK_HOBJECT_H_GET_BASE(heap, h)                        \
      ((duk_uint32_t*)(void*)(DUK_HOBJECT_GET_PROPS((heap), (h)) + \
                              ...
                              DUK_HOBJECT_GET_ASIZE((h)) * sizeof(duk_tval)))
#    define DUK_HOBJECT_P_COMPUTE_SIZE(n_ent, n_arr, n_hash)     \
      ((n_ent) * (sizeof(duk_propvalue) + sizeof(duk_hstring*) + \
                  sizeof(duk_uint8_t)) +                         \
       (n_arr) * sizeof(duk_tval) + (n_hash) * sizeof(duk_uint32_t))
#    define DUK_HOBJECT_P_SET_REALLOC_PTRS(p_base, set_e_k, set_e_pv, set_e_f, \
                                           set_a, set_h, n_ent, n_arr, n_hash) \
...
#  define DUK_HOBJECT_E_SLOT_SET_CONFIGURABLE(heap, h, i) \
    DUK_HOBJECT_E_SET_FLAG_BITS((heap), (h), (i),         \
                                DUK_PROPDESC_FLAG_CONFIGURABLE)
...
#    define DUK_HOBJECT_GET_PROTOTYPE(heap, h)                 \
      ((duk_hobject*)DUK_USE_HEAPPTR_DEC16((heap)->heap_udata, \
                                           (h)->prototype16))
...
#    define DUK_HOBJECT_HAS_FINALIZER_FAST(heap, h) \
      duk_hobject_has_finalizer_fast_raw((heap), (h))
#  else
#    define DUK_HOBJECT_HAS_FINALIZER_FAST(heap, h) \
...
#    define DUK_HOBJECT_MAX_PROPERTIES \
      0x3fffffffUL /* 2**30-1 ~= 1G properties */
#  endif
...
/* alloc and init */
DUK_INTERNAL_DECL duk_hobject* duk_hobject_alloc_unchecked(
    duk_heap* heap, duk_uint_t hobject_flags);
DUK_INTERNAL_DECL duk_hobject* duk_hobject_alloc(duk_hthread* thr,
                                                 duk_uint_t hobject_flags);
DUK_INTERNAL_DECL duk_harray* duk_harray_alloc(duk_hthread* thr,
                                               duk_uint_t hobject_flags);
DUK_INTERNAL_DECL duk_hcompfunc* duk_hcompfunc_alloc(duk_hthread* thr,
                                                     duk_uint_t hobject_flags);
DUK_INTERNAL_DECL duk_hnatfunc* duk_hnatfunc_alloc(duk_hthread* thr,
                                                   duk_uint_t hobject_flags);
DUK_INTERNAL_DECL duk_hboundfunc* duk_hboundfunc_alloc(
    duk_heap* heap, duk_uint_t hobject_flags);
#  if defined(DUK_USE_BUFFEROBJECT_SUPPORT)
DUK_INTERNAL_DECL duk_hbufobj* duk_hbufobj_alloc(duk_hthread* thr,
                                                 duk_uint_t hobject_flags);
#  endif
DUK_INTERNAL_DECL duk_hthread* duk_hthread_alloc_unchecked(
    duk_heap* heap, duk_uint_t hobject_flags);
DUK_INTERNAL_DECL duk_hthread* duk_hthread_alloc(duk_hthread* thr,
                                                 duk_uint_t hobject_flags);
DUK_INTERNAL_DECL duk_hdecenv* duk_hdecenv_alloc(duk_hthread* thr,
                                                 duk_uint_t hobject_flags);
DUK_INTERNAL_DECL duk_hobjenv* duk_hobjenv_alloc(duk_hthread* thr,
                                                 duk_uint_t hobject_flags);
DUK_INTERNAL_DECL duk_hproxy* duk_hproxy_alloc(duk_hthread* thr,
                                               duk_uint_t hobject_flags);

/* resize */
DUK_INTERNAL_DECL void duk_hobject_realloc_props(
    duk_hthread* thr, duk_hobject* obj, duk_uint32_t new_e_size,
    duk_uint32_t new_a_size, duk_uint32_t new_h_size, duk_bool_t abandon_array);
...
DUK_INTERNAL_DECL duk_bool_t duk_hobject_find_entry(duk_heap* heap,
                                                    duk_hobject* obj,
                                                    duk_hstring* key,
                                                    duk_int_t* e_idx,
                                                    duk_int_t* h_idx);
DUK_INTERNAL_DECL duk_tval* duk_hobject_find_entry_tval_ptr(duk_heap* heap,
                                                            duk_hobject* obj,
                                                            duk_hstring* key);
DUK_INTERNAL_DECL duk_tval* duk_hobject_find_entry_tval_ptr_stridx(
    duk_heap* heap, duk_hobject* obj, duk_small_uint_t stridx);
DUK_INTERNAL_DECL duk_tval* duk_hobject_find_entry_tval_ptr_and_attrs(
    duk_heap* heap, duk_hobject* obj, duk_hstring* key, duk_uint_t* out_attrs);
DUK_INTERNAL_DECL duk_tval* duk_hobject_find_array_entry_tval_ptr(
...
DUK_INTERNAL_DECL void duk_hobject_define_property_internal_arridx(
    ...
    duk_small_uint_t flags);
DUK_INTERNAL_DECL duk_size_t duk_hobject_get_length(duk_hthread* thr,
                                                    duk_hobject* obj);
#  if defined(DUK_USE_HEAPPTR16)
DUK_INTERNAL_DECL duk_bool_t
duk_hobject_has_finalizer_fast_raw(duk_heap* heap, duk_hobject* obj);
#  else
DUK_INTERNAL_DECL duk_bool_t
duk_hobject_has_finalizer_fast_raw(duk_hobject* obj);
#  endif

/* helpers for defineProperty() and defineProperties() */
DUK_INTERNAL_DECL void duk_hobject_prepare_property_descriptor(
    duk_hthread* thr, duk_idx_t idx_in, duk_uint_t* out_defprop_flags,
    duk_idx_t* out_idx_value, duk_hobject** out_getter,
    duk_hobject** out_setter);
DUK_INTERNAL_DECL duk_bool_t duk_hobject_define_property_helper(
...
DUK_INTERNAL_DECL void duk_hobject_object_get_own_property_descriptor(
...
/* internal properties */
DUK_INTERNAL_DECL duk_tval* duk_hobject_get_internal_value_tval_ptr(
    duk_heap* heap, duk_hobject* obj);
DUK_INTERNAL_DECL duk_hstring* duk_hobject_get_internal_value_string(
    duk_heap* heap, duk_hobject* obj);
DUK_INTERNAL_DECL duk_harray* duk_hobject_get_formals(duk_hthread* thr,
                                                      duk_hobject* obj);
DUK_INTERNAL_DECL duk_hobject* duk_hobject_get_varmap(duk_hthread* thr,
                                                      duk_hobject* obj);
...
/* ES2015 proxy */
#  if defined(DUK_USE_ES6_PROXY)
DUK_INTERNAL_DECL duk_bool_t duk_hobject_proxy_check(duk_hobject* obj,
...
DUK_INTERNAL_DECL void duk_hobject_enumerator_create(
    duk_hthread* thr, duk_small_uint_t enum_flags);
DUK_INTERNAL_DECL duk_ret_t
duk_hobject_get_enumerated_keys(duk_hthread* thr, duk_small_uint_t enum_flags);
DUK_INTERNAL_DECL duk_bool_t duk_hobject_enumerator_next(duk_hthread* thr,
...
DUK_INTERNAL_DECL duk_uint_fast32_t duk_hobject_pc2line_query(
    duk_hthread* thr, duk_idx_t idx_func, duk_uint_fast32_t pc);
#  endif
