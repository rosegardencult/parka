...
#  define DUK_BC_SHIFTED_MASK_ABC \
    (DUK_BC_UNSHIFTED_MASK_ABC << DUK_BC_SHIFT_ABC)
...
#  define DUK_ENC_OP_A_BC(op, a, bc)                                         \
    ((duk_instr_t)((((duk_instr_t)(bc)) << 16) | (((duk_instr_t)(a)) << 8) | \
                   ((duk_instr_t)(op))))
#  define DUK_ENC_OP_A_B_C(op, a, b, c)                                      \
    ((duk_instr_t)((((duk_instr_t)(c)) << 24) | (((duk_instr_t)(b)) << 16) | \
                   (((duk_instr_t)(a)) << 8) | ((duk_instr_t)(op))))
