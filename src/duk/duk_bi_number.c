...
DUK_INTERNAL duk_ret_t duk_bi_number_prototype_to_string(duk_hthread* thr) {
  ...
  duk_numconv_stringify(thr, radix /*radix*/, 0 /*digits*/,
                        n2s_flags /*flags*/);
  return 1;
}

DUK_INTERNAL duk_ret_t
duk_bi_number_prototype_to_locale_string(duk_hthread* thr) {
...
DUK_INTERNAL duk_ret_t duk_bi_number_prototype_to_fixed(duk_hthread* thr) {
  ...
  duk_numconv_stringify(thr, 10 /*radix*/, frac_digits /*digits*/,
                        n2s_flags /*flags*/);
  return 1;
...
DUK_INTERNAL duk_ret_t
duk_bi_number_prototype_to_exponential(duk_hthread* thr) {
  ...
  n2s_flags =
      DUK_N2S_FLAG_FORCE_EXP | (frac_undefined ? 0 : DUK_N2S_FLAG_FIXED_FORMAT);

  duk_numconv_stringify(thr, 10 /*radix*/,
...
DUK_INTERNAL duk_ret_t duk_bi_number_prototype_to_precision(duk_hthread* thr) {
  ...
  duk_numconv_stringify(thr, 10 /*radix*/, prec /*digits*/,
                        n2s_flags /*flags*/);
  return 1;
