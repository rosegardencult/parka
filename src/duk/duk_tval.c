...
DUK_INTERNAL DUK_ALWAYS_INLINE void duk_tval_set_number_chkfast_fast(
    duk_tval* tv, duk_double_t x) {
  duk_double_union du;
  duk_int64_t i;
...
DUK_INTERNAL DUK_NOINLINE void duk_tval_set_number_chkfast_slow(
    duk_tval* tv, duk_double_t x) {
...
duk_tval_get_number_packed(duk_tval* tv) {
  duk_double_union du;
  duk_uint64_t t;
