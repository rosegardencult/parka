...
#    define DUK_DBLUNION_GET_INT64(u) \
      ((duk_int64_t)DUK_DBLUNION_GET_UINT64((u)))
#  endif /* DUK_USE_64BIT_OPS */
 ...
 *  swapped; hence the #if defined()s below for ULL writes with
 * DUK_USE_DOUBLE_ME. This is not full ARM support but suffices for some
 * environments.
 */
...
#      define DUK__DBLUNION_IS_NAN_FULL(u)          \
        ((((u)->ull[DUK_DBL_IDX_ULL0] &             \
           DUK_U64_CONSTANT(0x000000007ff00000)) == \
          DUK_U64_CONSTANT(0x000000007ff00000)) &&  \
         ((((u)->ull[DUK_DBL_IDX_ULL0]) &           \
           DUK_U64_CONSTANT(0xffffffff000fffff)) != 0))
#      define DUK__DBLUNION_IS_NORMALIZED_NAN_FULL(u) \
        ((u)->ull[DUK_DBL_IDX_ULL0] == DUK_U64_CONSTANT(0x000000007ff80000))
#      define DUK__DBLUNION_IS_ANYINF(u)           \
        (((u)->ull[DUK_DBL_IDX_ULL0] &             \
          DUK_U64_CONSTANT(0xffffffff7fffffff)) == \
         DUK_U64_CONSTANT(0x000000007ff00000))
...
#      define DUK__DBLUNION_IS_ANYZERO(u)          \
        (((u)->ull[DUK_DBL_IDX_ULL0] &             \
          DUK_U64_CONSTANT(0xffffffff7fffffff)) == \
         DUK_U64_CONSTANT(0x0000000000000000))
...
#      define DUK__DBLUNION_IS_NAN_FULL(u)          \
        ((((u)->ull[DUK_DBL_IDX_ULL0] &             \
           DUK_U64_CONSTANT(0x7ff0000000000000)) == \
          DUK_U64_CONSTANT(0x7ff0000000000000)) &&  \
         ((((u)->ull[DUK_DBL_IDX_ULL0]) &           \
           DUK_U64_CONSTANT(0x000fffffffffffff)) != 0))
#      define DUK__DBLUNION_IS_NORMALIZED_NAN_FULL(u) \
        ((u)->ull[DUK_DBL_IDX_ULL0] == DUK_U64_CONSTANT(0x7ff8000000000000))
#      define DUK__DBLUNION_IS_ANYINF(u)           \
        (((u)->ull[DUK_DBL_IDX_ULL0] &             \
          DUK_U64_CONSTANT(0x7fffffffffffffff)) == \
         DUK_U64_CONSTANT(0x7ff0000000000000))
#      define DUK__DBLUNION_IS_POSINF(u) \
...
#    define DUK_DBLUNION_IS_NAN(u) \
      DUK__DBLUNION_IS_NAN_FULL((u)) /* (DUK_ISNAN((u)->d)) */
#    define DUK_DBLUNION_IS_NORMALIZED_NAN(u) \
      DUK__DBLUNION_IS_NAN_FULL((u)) /* (DUK_ISNAN((u)->d)) */
#    define DUK_DBLUNION_IS_NORMALIZED(u) \
...
#    define DUK_DBLUNION_HAS_SIGNBIT(u) \
      (((u)->ull[DUK_DBL_IDX_ULL0] & DUK_U64_CONSTANT(0x8000000000000000)) != 0)
#    define DUK_DBLUNION_GET_SIGNBIT(u) (((u)->ull[DUK_DBL_IDX_ULL0] >> 63U))
#  else
#    define DUK_DBLUNION_HAS_SIGNBIT(u) \
      (((u)->ui[DUK_DBL_IDX_UI0] & 0x80000000UL) != 0)
