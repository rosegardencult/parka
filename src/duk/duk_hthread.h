...
struct duk_activation {
  duk_tval tv_func; /* borrowed: full duk_tval for function being executed; for
                       lightfuncs */
  duk_hobject*
      func; /* borrowed: function being executed; for bound function calls, this
               is the final, real function, NULL for lightfuncs */
...
struct duk_hthread {
  ...
  duk_size_t
      callstack_top; /* number of activation records in callstack (0 if none) */
...
DUK_INTERNAL_DECL duk_activation* duk_hthread_activation_alloc(
    duk_hthread* thr);
...
DUK_INTERNAL_DECL void duk_hthread_activation_unwind_reuse_norz(
    duk_hthread* thr);
DUK_INTERNAL_DECL duk_activation* duk_hthread_get_activation_for_level(
...
DUK_INTERNAL_DECL void duk_hthread_catcher_unwind_norz(duk_hthread* thr,
                                                       duk_activation* act);
DUK_INTERNAL_DECL void duk_hthread_catcher_unwind_nolexenv_norz(
