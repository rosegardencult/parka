...
DUK_EXTERNAL void duk_time_to_components(duk_hthread* thr, duk_double_t timeval,
  ...
  DUK_ASSERT(dparts[DUK_DATE_IDX_MONTH] >= 1.0 &&
             dparts[DUK_DATE_IDX_MONTH] <= 12.0);
