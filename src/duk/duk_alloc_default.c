...
DUK_INTERNAL void* duk_default_alloc_function(void* udata, duk_size_t size) {
  ...
  DUK_DDD(DUK_DDDPRINT("default alloc function: %lu -> %p", (unsigned long)size,
                       (void*)res));
  return res;
}
...
DUK_INTERNAL void* duk_default_realloc_function(void* udata, void* ptr,
  ...
  DUK_DDD(DUK_DDDPRINT("default realloc function: %p %lu -> %p", (void*)ptr,
                       (unsigned long)newsize, (void*)res));
  return res;
}
