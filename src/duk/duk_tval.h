...
#        define DUK__TVAL_SET_TAGGEDPOINTER(tv, h, tag)                      \
          do {                                                               \
            (tv)->ull[DUK_DBL_IDX_ULL0] = (((duk_uint64_t)(tag)) << 48) |    \
...
#        define DUK__TVAL_SET_LIGHTFUNC(tv, fp, flags)      \
          do {                                              \
            (tv)->ull[DUK_DBL_IDX_ULL0] =                   \
                (((duk_uint64_t)DUK_TAG_LIGHTFUNC) << 16) | \
                ((duk_uint64_t)(flags)) |                   \
...
#        define DUK__TVAL_SET_LIGHTFUNC(tv, fp, flags)      \
          do {                                              \
            (tv)->ull[DUK_DBL_IDX_ULL0] =                   \
                (((duk_uint64_t)DUK_TAG_LIGHTFUNC) << 48) | \
...
#      define DUK__TVAL_SET_LIGHTFUNC(tv, fp, flags)         \
        do {                                                 \
          ...
          duk__tv->ui[DUK_DBL_IDX_UI0] =                     \
              (((duk_uint32_t)DUK_TAG_LIGHTFUNC) << 16) |    \
              ((duk_uint32_t)(flags));                       \
...
#        define DUK__TVAL_SET_I48(tv, i)                      \
          do {                                                \
            ...
            duk__tv = (tv);                                   \
            duk__tv->ui[DUK_DBL_IDX_UI0] =                    \
                ((duk_uint32_t)DUK_TAG_FASTINT) << 16 |       \
...
#        define DUK__TVAL_SET_U32(tv, i)                                   \
          do {                                                             \
            duk_tval* duk__tv;                                             \
            duk__tv = (tv);                                                \
            duk__tv->ui[DUK_DBL_IDX_UI0] = ((duk_uint32_t)DUK_TAG_FASTINT) \
                                           << 16;                          \
            duk__tv->ui[DUK_DBL_IDX_UI1] = (duk_uint32_t)(i);              \
          } while (0)
#      else
#        define DUK__TVAL_SET_I48(tv, i)                                      \
          do {                                                                \
            (tv)->ull[DUK_DBL_IDX_ULL0] =                                     \
                ...
                (((duk_uint64_t)(i)) & DUK_U64_CONSTANT(0x0000ffffffffffff)); \
          } while (0)
#        define DUK__TVAL_SET_U32(tv, i)                                     \
          do {                                                               \
            (tv)->ull[DUK_DBL_IDX_ULL0] =                                    \
...
#        define DUK__TVAL_GET_FASTINT(tv)                                     \
          (((duk_int64_t)((((duk_uint64_t)(tv)->ui[DUK_DBL_IDX_UI0]) << 32) | \
                          ((duk_uint64_t)(tv)->ui[DUK_DBL_IDX_UI1])))         \
               << 16 >>                                                       \
           16)
#      else
#        define DUK__TVAL_GET_FASTINT(tv) \
          ((((duk_int64_t)(tv)->ull[DUK_DBL_IDX_ULL0]) << 16) >> 16)
#      endif
#      define DUK__TVAL_GET_FASTINT_U32(tv) ((tv)->ui[DUK_DBL_IDX_UI1])
#      define DUK__TVAL_GET_FASTINT_I32(tv) \
        ((duk_int32_t)(tv)->ui[DUK_DBL_IDX_UI1])
...
#    define DUK_TVAL_SET_BOOLEAN(tv, val)                                     \
      DUK_DBLUNION_SET_HIGH32((tv), (((duk_uint32_t)DUK_TAG_BOOLEAN) << 16) | \
                                        ((duk_uint32_t)(val)))
...
#      define DUK_TVAL_SET_I48(tv, i) \
        DUK_TVAL_SET_DOUBLE((tv),     \
                            (duk_double_t)(i)) /* XXX: fast int-to-double */
#      define DUK_TVAL_SET_I32(tv, i) \
        DUK_TVAL_SET_DOUBLE((tv), (duk_double_t)(i))
#      define DUK_TVAL_SET_U32(tv, i) \
        DUK_TVAL_SET_DOUBLE((tv), (duk_double_t)(i))
#      define DUK_TVAL_SET_NUMBER_CHKFAST_FAST(tv, d) \
...
#    define DUK_TVAL_SET_STRING(tv, h) \
      DUK__TVAL_SET_TAGGEDPOINTER((tv), (h), DUK_TAG_STRING)
#    define DUK_TVAL_SET_OBJECT(tv, h) \
      DUK__TVAL_SET_TAGGEDPOINTER((tv), (h), DUK_TAG_OBJECT)
#    define DUK_TVAL_SET_BUFFER(tv, h) \
      DUK__TVAL_SET_TAGGEDPOINTER((tv), (h), DUK_TAG_BUFFER)
#    define DUK_TVAL_SET_POINTER(tv, p) \
      DUK__TVAL_SET_TAGGEDPOINTER((tv), (p), DUK_TAG_POINTER)
...
#    define DUK_TVAL_GET_BOOLEAN(tv) \
      ((duk_small_uint_t)(tv)->us[DUK_DBL_IDX_US1])
#    if defined(DUK_USE_FASTINT)
...
#    define DUK_TVAL_GET_LIGHTFUNC_FUNCPTR(tv) \
      ((duk_c_function)((tv)->ui[DUK_DBL_IDX_UI1]))
#    define DUK_TVAL_GET_LIGHTFUNC_FLAGS(tv) \
      (((duk_small_uint_t)(tv)->ui[DUK_DBL_IDX_UI0]) & 0xffffUL)
...
#    define DUK_TVAL_IS_UNDEFINED(tv) \
      (DUK_TVAL_GET_TAG((tv)) == DUK_TAG_UNDEFINED)
...
#    define DUK_TVAL_IS_BOOLEAN_TRUE(tv) \
      ((tv)->ui[DUK_DBL_IDX_UI0] == DUK_XTAG_BOOLEAN_TRUE)
#    define DUK_TVAL_IS_BOOLEAN_FALSE(tv) \
      ((tv)->ui[DUK_DBL_IDX_UI0] == DUK_XTAG_BOOLEAN_FALSE)
#    define DUK_TVAL_IS_LIGHTFUNC(tv) \
      (DUK_TVAL_GET_TAG((tv)) == DUK_TAG_LIGHTFUNC)
...
#      define DUK_TVAL_IS_FASTINT(tv) \
        (DUK_TVAL_GET_TAG((tv)) == DUK_TAG_FASTINT)
...
#    define DUK_TVAL_IS_HEAP_ALLOCATED(tv) \
      (DUK_TVAL_GET_TAG((tv)) >= DUK_TAG_STRING)
...
#    define DUK_TAG_NUMBER \
      0 /* DUK_TAG_NUMBER only defined for non-packed duk_tval */
#    if defined(DUK_USE_FASTINT)
...
#      define DUK_TVAL_SET_DOUBLE(tv, val)                  \
        do {                                                \
          ...
          DUK_ASSERT_DOUBLE_IS_NORMALIZED(                  \
              duk__dblval); /* nop for unpacked duk_tval */ \
          duk__tv = (tv);                                   \
...
#      define DUK_TVAL_SET_I48(tv, val) \
        DUK_TVAL_SET_NUMBER((tv),       \
                            (duk_double_t)(val)) /* XXX: fast int-to-double */
#      define DUK_TVAL_SET_U32(tv, val) \
...
#      define DUK_TVAL_IS_NUMBER(tv) \
        ((tv)->t == DUK_TAG_NUMBER || (tv)->t == DUK_TAG_FASTINT)
#    else
